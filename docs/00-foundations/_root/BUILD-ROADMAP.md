...
|---|---|---|---|---|---|
| R1 | Merge doc chain to `main` (3-deep stack + this) | awaiting-greenlight | DR-0017…024; PR #15/#16 | Darrell greenlight; merge bottom-up | Darrell |
...
| R4 | Cage + local LLM runner stand-up | blocked-on | DR-0037, DR-0040; three-brakes | CUDA box + deploy (unlocks R5/R6/R11) | Darrell + Claude |
