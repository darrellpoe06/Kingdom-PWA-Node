...
**Forward architectural fix:** extend the DR-0060 tenancy guard with a third class — identity/personalization gated on `authSession` alone (not `isFamilyEmail`) fails the build — proven to CATCH the break before it ships (DR-0060 anti-theater discipline). Governed by DR-0074.
