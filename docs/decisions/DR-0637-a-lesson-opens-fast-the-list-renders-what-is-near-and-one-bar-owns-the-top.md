# DR-0637 — A lesson opens fast: the list renders what is near the reader, the print copy exists only while printing, and one bar owns the top of an open lesson
