...
- `node --check scripts/live-link-probe.mjs` clean; the-level-witness-can-be-read pins hold; live measurement: live-link-probe run 35931484959 on this branch (its report names what was in flight, or that idle was reached).
