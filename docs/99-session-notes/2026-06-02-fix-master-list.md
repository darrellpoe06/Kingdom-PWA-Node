...
| Q7 | Loved Ones chosen-family cohort cap (open-ended at present, COLG had the 100 anchor) | `project_loved_ones_cohort_includes_chosen_family` | **CLOSED** 2026-06-03 — Darrell: "Both. Church family gated friends and family members open ended at Christina and my discretion." Two rails: Church-family GATED (first-100-COLG anchor), chosen-family OPEN-ENDED at **Christina's AND Darrell's joint discretion** (Christina now a named co-authority). Binding memory `project_loved_ones_cohort_includes_chosen_family`; card copy clarified in commit `42c4959`. |
