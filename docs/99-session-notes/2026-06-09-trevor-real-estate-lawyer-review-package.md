...
**Decision record:** DR-010 (Trevor review scope + the employment-law scope flag) — see `docs/decisions/INDEX.md`.
...
This scope split is recorded as **DR-005** (in the market-strategy doc) and **DR-010** (this package).
