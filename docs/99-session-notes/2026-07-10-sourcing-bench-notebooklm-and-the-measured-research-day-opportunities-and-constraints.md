...
- **Ari + reports** — the `sourcing` standing duty resolves against DR-0143 live; the derived notes pick the DR up this build; every `re-review:` date in the DR/REV lands in the sortable in-app backlog automatically (the existing extractor — nothing new needed).
...
## Opportunities (all routed in DR-0143 with dates)
