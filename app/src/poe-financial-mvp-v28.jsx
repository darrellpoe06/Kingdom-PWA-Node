          ...
          <div className="bg-[#FAF8F4] border border-[#1A1815] max-w-3xl w-full p-6 sm:p-8 my-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-4">
              {[
                ...
                { key: 'church',      free: false, label: 'For church leadership',           headline: 'Tithe in, ministry out, every dollar provable.',                summary: "The Black Church has pooled capital to lift its people for 200 years - from 1787 mutual aid to colleges built on washerwomen's pennies. PoeTech hands that stewardship genealogy provable books: tithes in, ministry and capex out, so the board votes on numbers, not memory. Soul first, then the family economy - the Spiritual Module for the Body is free; the congregation's stewardship books are the paid tier." },
