...
const ROADMAP = [
  ...
  { id: 'bank-automation', title: 'Banking on autopilot (set up once, no human after)', what: 'Your bank emails statements → your own Gmail → your own NAS → verified ledger → the app. Built with all three brakes; awaiting one supervised switch-on. A richer aggregator tier (Plaid via your NAS) is the opt-in upgrade.', status: 'gated', when: 'your one-click supervised activation of workflow 21' },
