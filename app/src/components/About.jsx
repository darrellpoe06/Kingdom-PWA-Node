    ...
    <div className="space-y-10 w-full">
      <section>
        ...
        <div className="mb-5">
          ...
          <div className="mt-2 px-3 py-2 bg-[#FAF8F4] border-l-2 border-[#5A6E3D] text-xs text-[#5A5751]" style={{ fontFamily: '"Fraunces", serif' }}>
            <strong className="text-[#1A1815]">Your data is always yours.</strong> Free export (CSV / JSON / OFX) — no paywall, ever — is in build and not wired yet. A gentle 30-day backup reminder ships with it, so a lost phone never means lost records. Until then, transaction and report CSV exports on the money pages already work.
          </div>
        </div>
        ...
        {/* Four free pathways — surfaced above the paid ladder. Per Darrell
            ...
            for those the work of justice names: Loved Ones (The Church of the
            Living God — The Love Corner — + chosen family)
            and Community (families in genuine need, funded by aligned-brand
      ...
      <section>
        ...
        {/* 2026-06-03 — Body-of-Christ economic-stewardship lens per Darrell's mission
            ...
            understanding as deliverable (Prov 4:7), engineered wealth gap named, and the
      ...
      <section>
        ...
        <p className="text-sm text-[#5A5751] leading-relaxed mb-3" style={{ fontFamily: '"Fraunces", serif' }}>
          Live modules ship to all subscribers. Planned and Vision modules accept early interest signals — tap <strong>Vote on priority</strong> to weigh in on what gets built next. Signed in, votes pool across the family (module_interest) and that real aggregate shapes the roadmap; signed out, votes stay on this device until you sign in. (Launch notifications for voters are on the build list — today your vote steers, it doesn't yet notify.)
        </p>
      ...
      <section className="bg-white border-2 border-[#B85838] p-5">
        ...
        <p className="text-sm leading-relaxed" style={{ fontFamily: '"Fraunces", serif' }}>
          Questions before paying? Email <strong>contact@poetech.us</strong> with your mission, business model, ownership, regulatory status, and which tier you're considering. We aim to respond within 3 business days. Limited slots — current opening status published quarterly.
        </p>
      </section>
            ...
            <div className="p-5 space-y-4">
              {cartTier.isSponsor ? (
                ...
                <div className="bg-[#FAF8F4] border border-[#5A6E3D] p-3">
                  ...
                  <p className="text-xs mt-1" style={{ fontFamily: '"Fraunces", serif' }}>Sending the pre-filled email finishes your claim — we confirm eligibility and reply with access details. No card needed.</p>
                </div>
              )}
