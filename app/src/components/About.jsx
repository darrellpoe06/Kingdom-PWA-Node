    ...
    <div className="space-y-10 max-w-prose">
      <section>
        ...
        {/* Four free pathways — surfaced above the paid ladder. Per Darrell
            ...
            for those the work of justice names: Loved Ones (COLG + chosen family)
