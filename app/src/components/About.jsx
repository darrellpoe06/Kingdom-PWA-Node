  ...
  return (
    <div className="space-y-10 max-w-prose">
      <section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <PricingTier name="Loved Ones · Founding Family" bestFor="warm-market founding families — free PoeTech+ for life." tagline="Free PoeTech+ upgrade for life · First 100 families through Church of the Living God or by direct invitation" monthly="0" annual="0" replaces="Lifetime savings of ~$468/yr per family at current prices · more as prices rise" features={['Everything in Foundation','Cross-device sync (opt-in cloud)','Encrypted cloud backup','Multi-user household sharing','Locked in for life — even when prices change','First 100 families only · tier closes when filled','One month Household-tier credit per paying family you refer']} community onChoose={openCart} />
