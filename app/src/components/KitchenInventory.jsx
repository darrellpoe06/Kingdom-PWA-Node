    ...
    <div className="border border-[#B85838] bg-white p-3 mb-3">
      ...
      <div className="flex gap-2 mt-3">
        <button
          ...
          disabled={!canAdd}
          onClick={() => onAdd(
            { name: f.name.trim(), sku: f.sku.trim() || null, category: f.category, location: f.location, unit: f.unit, reorderPoint: Number(f.reorderPoint) || 0, unitCost: Number(f.unitCost) || 0 },
