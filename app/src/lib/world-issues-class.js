...
const AI_EMPIRE_ISSUE = {
  ...
  lens: {
    ...
    benefits: [
      ...
      'Governance-is-reality (DR-0168): predict outcomes from the accountable STRUCTURE, not the CEO\u2019s professed goodness \u2014 the corrupt hate the light and the upright come to it (John 3:20-21); clarity, not a better billionaire, is the fix.',
