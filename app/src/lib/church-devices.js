...
export const SEED_DEVICES = [
  ...
  makeDevice({
    id: 'dev-gpu-node-1',
    name: 'CUDA tower — livestream-main-pc (RTX 4070)',
    deviceType: 'gpu-node',
    makeModel: 'Windows 11 Home (build 26200) tower, NVIDIA RTX 4070 12 GB',
    location: 'Church control room',
    status: 'online',
    steward: 'COLG media team',
    specs: {
      gpu: 'NVIDIA RTX 4070, 12 GB VRAM (nvidia-smi, 2026-07-03)',
      driver: '595.95 (WDDM), CUDA 13.2 max',
      tailscale: 'livestream-main-pc — 100.72.5.90',
      resident: 'Claude Code 2.1.200 (Claude Max) + CLAUDE.md role file',
      pipeline: 'faster-whisper transcription pipeline install in progress (Python 3.12 + ffmpeg + faster-whisper)',
      note: 'DR-0012: do NOT run inference during live services on the box encoding the stream (this IS the livestream box). Tactical RMM agent found on the machine - identify who manages it.',
    },
    capabilities: ['llm-inference', 'transcription', 'voice-clone', 'video-encode'],
    notes: 'VERIFIED on site 2026-07-03: hostname, GPU, driver, tailnet address read off the machine; Claude Code signed in (Claude Max). Earlier-listed AI services (ollama/voice-studio/whisper-gpu) were NOT found during the 2026-07-03 inventory - no Python was installed; service layout still to confirm.',
    smeNeeded: true,
    confirmed: true,
    sortOrder: 20,
  }),
