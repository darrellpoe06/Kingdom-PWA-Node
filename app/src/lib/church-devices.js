...
export const SEED_DEVICES = [
  ...
  makeDevice({
    ...
    specs: {
      mac: 'DC-ED-84-A0-B4-CA — scan-confirmed 2026-09-18. DC-ED-84 is shared by all three PTZOptics cameras, which is how that prefix was established from this estate itself.',
  ...
  makeDevice({
    ...
    specs: {
      protocol: 'NDI + SDI; SSH-enabled', control: 'Browser PTZ page (Presets 1-9).',
      mac: 'DC-ED-84-A0-B4-59 — scan-confirmed 2026-09-18.',
    },
    capabilities: ['capture'],
    notes: 'Feeds the ATEM (SDI) and the LAN as NDI. SSH reachable. Exact PTZOptics model to read off the unit.',
    provenance: 'scan-confirmed 2026-07-08',
  ...
  makeDevice({
    ...
    specs: {
      protocol: 'NDI + SDI; SSH-enabled', control: 'Browser PTZ page (Presets 1-9).',
      mac: 'DC-ED-84-A0-B3-B4 — scan-confirmed 2026-09-18.',
    },
    capabilities: ['capture'],
    notes: 'Feeds the ATEM (SDI) and the LAN as NDI. SSH reachable. Exact PTZOptics model to read off the unit.',
    provenance: 'scan-confirmed 2026-07-08',
  ...
  makeDevice({
    ...
    specs: {
      mac: '7C-2E-0D-0D-6C-32 (Blackmagic Design, oui-derived) — scan-confirmed 2026-09-18',
  ...
  makeDevice({
    ...
    specs: {
      mac: '00-11-32-41-CF-3D (Synology, oui-derived) — scan-confirmed 2026-09-18',
  ...
  makeDevice({
    ...
    specs: {
      ips: '192.168.0.136, 192.168.0.137 (two Netgear endpoints)',
      unconfirmed: 'Vendor reads as Netgear; role (switch / AP / router) NOT confirmed.',
      macs: '10-DA-43-3C-88-2E (.136) + 10-DA-43-42-7F-8D (.137). The shared 10-DA-43 prefix CONFIRMS both endpoints are one manufacturer and corroborates the 2026-07-08 Netgear vendor read — scan-confirmed 2026-09-18. Role (switch / AP / router) still needs-eyes-on.',
    },
    capabilities: ['networking'],
  ...
  // ---------------------------------------------------------------------------
  // 2026-09-18 CHURCH LAN RESCAN — 23 hosts that were LIVE and absent from this
  // register. 41 hosts answered; this register held 18 of them, so it knew 44% of
  // its own network. That gap is the finding underneath every other finding: you
  // cannot secure, patch or even locate what was never written down.
  //
  // Generated by scripts/propose-register-rows.mjs from
  // docs/99-session-notes/scans/colg-network-scan-2026-09-18-1301.json, then
  // committed deliberately rather than left in a review file — an asset register
  // that does not contain the assets is not a register.
  //
  // EVERY ROW IS HONEST (DR-0076). The scan proves a host ANSWERED at an address;
  // it does not prove what the box IS. So every row is confirmed:false /
  // smeNeeded:true, the address carries 'scan-confirmed 2026-09-18', a vendor (where
  // a MAC gave one) carries the strictly-weaker 'oui-derived', and 22 of 23 classify
  // as deviceType 'other' because no strong signal existed. An honest "we do not
  // know" beats a plausible wrong answer on a church asset record.
  // ---------------------------------------------------------------------------

  // TYPE INFERENCE: other <- No strong signal - classify on eyes-on rather than guess
  makeDevice({
    id: 'dev-scan-other-0-9',
    name: 'Unidentified host at 192.168.0.9',
    deviceType: 'other',
    makeModel: 'UNKNOWN (MAC gave no vendor - NEEDS EYES-ON)',
    location: 'Church (TBD - locate on the closet walk)',
    status: 'online',
    steward: 'COLG media team',
    ipAddress: '192.168.0.9',
    specs: {
      mac: 'A0-D2-B1-F6-5D-5D',
      services: 'no TCP services answered',
      discovered: 'Found live on the 2026-09-18 church LAN scan; absent from the register before it.',
    },
    capabilities: [],
    notes: 'Discovered by the 2026-09-18 scan. Type inferred from No strong signal - classify on eyes-on rather than guess. Make/model/role NOT confirmed - identify on the closet walk.',
    provenance: 'scan-confirmed 2026-09-18 (address); oui-derived (vendor); needs-eyes-on (model + role)',
    smeNeeded: true,
    confirmed: false,
  }),
  ...
  // TYPE INFERENCE: other <- No strong signal - classify on eyes-on rather than guess
  makeDevice({
    id: 'dev-scan-other-0-10',
    name: 'Unidentified host at 192.168.0.10',
    deviceType: 'other',
    makeModel: 'UNKNOWN (MAC gave no vendor - NEEDS EYES-ON)',
    location: 'Church (TBD - locate on the closet walk)',
    status: 'online',
  ...
  // TYPE INFERENCE: other <- No strong signal - classify on eyes-on rather than guess
  makeDevice({
    id: 'dev-scan-other-0-29',
    name: 'Unidentified host at 192.168.0.29',
    deviceType: 'other',
    makeModel: 'UNKNOWN (MAC gave no vendor - NEEDS EYES-ON)',
    location: 'Church (TBD - locate on the closet walk)',
    status: 'online',
  ...
  // TYPE INFERENCE: other <- No strong signal - classify on eyes-on rather than guess
  makeDevice({
    id: 'dev-scan-other-0-39',
    name: 'Unidentified host at 192.168.0.39',
    deviceType: 'other',
    makeModel: 'UNKNOWN (MAC gave no vendor - NEEDS EYES-ON)',
    location: 'Church (TBD - locate on the closet walk)',
    status: 'online',
  ...
  // TYPE INFERENCE: other <- No strong signal - classify on eyes-on rather than guess
  makeDevice({
    id: 'dev-scan-other-0-42',
    name: 'Unidentified host at 192.168.0.42',
    deviceType: 'other',
    makeModel: 'UNKNOWN (MAC gave no vendor - NEEDS EYES-ON)',
    location: 'Church (TBD - locate on the closet walk)',
    status: 'online',
  ...
  // TYPE INFERENCE: other <- No strong signal - classify on eyes-on rather than guess
  makeDevice({
    id: 'dev-scan-other-0-45',
    name: 'Unidentified host at 192.168.0.45',
    deviceType: 'other',
    makeModel: 'UNKNOWN (MAC gave no vendor - NEEDS EYES-ON)',
    location: 'Church (TBD - locate on the closet walk)',
    status: 'online',
  ...
  // TYPE INFERENCE: other <- No strong signal - classify on eyes-on rather than guess
  makeDevice({
    id: 'dev-scan-other-0-103',
    name: 'Unidentified host at 192.168.0.103',
    deviceType: 'other',
    makeModel: 'UNKNOWN (MAC gave no vendor - NEEDS EYES-ON)',
    location: 'Church (TBD - locate on the closet walk)',
    status: 'online',
  ...
  // TYPE INFERENCE: other <- No strong signal - classify on eyes-on rather than guess
  makeDevice({
    id: 'dev-scan-other-0-125',
    name: 'Unidentified host at 192.168.0.125',
    deviceType: 'other',
    makeModel: 'UNKNOWN (MAC gave no vendor - NEEDS EYES-ON)',
    location: 'Church (TBD - locate on the closet walk)',
    status: 'online',
    ...
    specs: {
      mac: '00-10-36-0A-3B-28',
      services: '22/SSH, 80/HTTP, 443/HTTPS',
      banner: 'The underlying connection was closed: Could not establish trust relationship for the SSL/TLS secure channel.',
      discovered: 'Found live on the 2026-09-18 church LAN scan; absent from the register before it.',
    },
    capabilities: [],
    notes: 'Discovered by the 2026-09-18 scan. Type inferred from No strong signal - classify on eyes-on rather than guess. Make/model/role NOT confirmed - identify on the closet walk.',
  ...
  // TYPE INFERENCE: audio-console <- Yamaha OUI - audio console
  makeDevice({
    id: 'dev-scan-audio-console-0-135',
    name: 'Yamaha device at 192.168.0.135',
    deviceType: 'audio-console',
    makeModel: 'Yamaha (oui-derived; model UNSURE - NEEDS EYES-ON)',
    location: 'Church (TBD - locate on the closet walk)',
    status: 'online',
    steward: 'COLG media team',
    ipAddress: '192.168.0.135',
    specs: {
      mac: '00-A0-DE-5C-A5-A6',
      services: 'no TCP services answered',
      discovered: 'Found live on the 2026-09-18 church LAN scan; absent from the register before it.',
    },
    capabilities: [],
    notes: 'Discovered by the 2026-09-18 scan. Type inferred from Yamaha OUI - audio console. Make/model/role NOT confirmed - identify on the closet walk.',
    provenance: 'scan-confirmed 2026-09-18 (address); oui-derived (vendor); needs-eyes-on (model + role)',
    smeNeeded: true,
    confirmed: false,
  }),
  ...
  // TYPE INFERENCE: other <- No strong signal - classify on eyes-on rather than guess
  makeDevice({
    id: 'dev-scan-other-0-142',
    name: 'Unidentified host at 192.168.0.142',
    deviceType: 'other',
    makeModel: 'UNKNOWN (MAC gave no vendor - NEEDS EYES-ON)',
    location: 'Church (TBD - locate on the closet walk)',
    status: 'online',
    ...
    specs: {
      mac: '60-22-32-15-03-5D',
      services: '22/SSH, 8080/HTTP proxy / alt',
      banner: 'The underlying connection was closed: The connection was closed unexpectedly.',
      discovered: 'Found live on the 2026-09-18 church LAN scan; absent from the register before it.',
    },
    capabilities: [],
    notes: 'Discovered by the 2026-09-18 scan. Type inferred from No strong signal - classify on eyes-on rather than guess. Make/model/role NOT confirmed - identify on the closet walk.',
  ...
  // TYPE INFERENCE: other <- No strong signal - classify on eyes-on rather than guess
  makeDevice({
    id: 'dev-scan-other-0-147',
    name: 'Unidentified host at 192.168.0.147',
    deviceType: 'other',
    makeModel: 'UNKNOWN (MAC gave no vendor - NEEDS EYES-ON)',
    location: 'Church (TBD - locate on the closet walk)',
    status: 'online',
  ...
  // TYPE INFERENCE: other <- No strong signal - classify on eyes-on rather than guess
  makeDevice({
    id: 'dev-scan-other-0-150',
    name: 'Unidentified host at 192.168.0.150',
    deviceType: 'other',
    makeModel: 'UNKNOWN (MAC gave no vendor - NEEDS EYES-ON)',
    location: 'Church (TBD - locate on the closet walk)',
    status: 'online',
  ...
  // TYPE INFERENCE: other <- No strong signal - classify on eyes-on rather than guess
  makeDevice({
    id: 'dev-scan-other-0-158',
    name: 'Unidentified host at 192.168.0.158',
    deviceType: 'other',
    makeModel: 'UNKNOWN (MAC gave no vendor - NEEDS EYES-ON)',
    location: 'Church (TBD - locate on the closet walk)',
    status: 'online',
  ...
  // TYPE INFERENCE: other <- No strong signal - classify on eyes-on rather than guess
  makeDevice({
    id: 'dev-scan-other-0-215',
    name: 'Unidentified host at 192.168.0.215',
    deviceType: 'other',
    makeModel: 'UNKNOWN (MAC gave no vendor - NEEDS EYES-ON)',
    location: 'Church (TBD - locate on the closet walk)',
    status: 'online',
  ...
  // TYPE INFERENCE: other <- No strong signal - classify on eyes-on rather than guess
  makeDevice({
    id: 'dev-scan-other-1-19',
    name: 'Unidentified host at 192.168.1.19',
    deviceType: 'other',
    makeModel: 'UNKNOWN (MAC gave no vendor - NEEDS EYES-ON)',
    location: 'Church (TBD - locate on the closet walk)',
    status: 'online',
  ...
  // TYPE INFERENCE: other <- No strong signal - classify on eyes-on rather than guess
  makeDevice({
    id: 'dev-scan-other-1-22',
    name: 'Unidentified host at 192.168.1.22',
    deviceType: 'other',
    makeModel: 'UNKNOWN (MAC gave no vendor - NEEDS EYES-ON)',
    location: 'Church (TBD - locate on the closet walk)',
    status: 'online',
  ...
  // TYPE INFERENCE: other <- No strong signal - classify on eyes-on rather than guess
  makeDevice({
    id: 'dev-scan-other-1-59',
    name: 'Unidentified host at 192.168.1.59',
    deviceType: 'other',
    makeModel: 'UNKNOWN (MAC gave no vendor - NEEDS EYES-ON)',
    location: 'Church (TBD - locate on the closet walk)',
    status: 'online',
  ...
  // TYPE INFERENCE: other <- No strong signal - classify on eyes-on rather than guess
  makeDevice({
    id: 'dev-scan-other-1-118',
    name: 'Unidentified host at 192.168.1.118',
    deviceType: 'other',
    makeModel: 'UNKNOWN (MAC gave no vendor - NEEDS EYES-ON)',
    location: 'Church (TBD - locate on the closet walk)',
    status: 'online',
    ...
    specs: {
      mac: '60-E9-AA-B6-4D-65',
      services: '22/SSH, 81/HTTP (alt)',
      banner: 'NDI Studio Monitor',
      discovered: 'Found live on the 2026-09-18 church LAN scan; absent from the register before it.',
    },
    capabilities: [],
    notes: 'Discovered by the 2026-09-18 scan. Type inferred from No strong signal - classify on eyes-on rather than guess. Make/model/role NOT confirmed - identify on the closet walk.',
  ...
  // TYPE INFERENCE: other <- No strong signal - classify on eyes-on rather than guess
  makeDevice({
    id: 'dev-scan-other-1-120',
    name: 'Unidentified host at 192.168.1.120',
    deviceType: 'other',
    makeModel: 'UNKNOWN (MAC gave no vendor - NEEDS EYES-ON)',
    location: 'Church (TBD - locate on the closet walk)',
    status: 'online',
  ...
  // TYPE INFERENCE: other <- No strong signal - classify on eyes-on rather than guess
  makeDevice({
    id: 'dev-scan-other-1-165',
    name: 'Unidentified host at 192.168.1.165',
    deviceType: 'other',
    makeModel: 'UNKNOWN (MAC gave no vendor - NEEDS EYES-ON)',
    location: 'Church (TBD - locate on the closet walk)',
    status: 'online',
  ...
  // TYPE INFERENCE: other <- No strong signal - classify on eyes-on rather than guess
  makeDevice({
    id: 'dev-scan-other-1-179',
    name: 'Unidentified host at 192.168.1.179',
    deviceType: 'other',
    makeModel: 'UNKNOWN (MAC gave no vendor - NEEDS EYES-ON)',
    location: 'Church (TBD - locate on the closet walk)',
    status: 'online',
  ...
  // TYPE INFERENCE: other <- No strong signal - classify on eyes-on rather than guess
  makeDevice({
    id: 'dev-scan-other-1-214',
    name: 'Unidentified host at 192.168.1.214',
    deviceType: 'other',
    makeModel: 'UNKNOWN (MAC gave no vendor - NEEDS EYES-ON)',
    location: 'Church (TBD - locate on the closet walk)',
    status: 'online',
  ...
  // TYPE INFERENCE: other <- No strong signal - classify on eyes-on rather than guess
  makeDevice({
    id: 'dev-scan-other-1-220',
    name: 'Unidentified host at 192.168.1.220',
    deviceType: 'other',
    makeModel: 'UNKNOWN (MAC gave no vendor - NEEDS EYES-ON)',
    location: 'Church (TBD - locate on the closet walk)',
    status: 'online',
