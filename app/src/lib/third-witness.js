...
export function witnessClientModule() {
  return {
    ...
    word: { principle: 'A righteous person falls seven times and rises again; Yahweh’s mercies are new every morning, so a setback is a morning away from a fresh start.', verses: ['Proverbs 24:16', 'Lamentations 3:22-23', 'Psalms 37:23-24'], reflection: 'The dopamine dip is biology; the getting-up-again is faith and biology together. One small action before motivation arrives is what rising looks like on a Tuesday.' },
    quiz: { questions: [
...
export function witnessWellnessModule() {
  return {
    ...
    word: { principle: 'The body is a temple to be tended with wisdom, meals in due season are for strength, and every food is received with thanksgiving — none of it under compulsion.', verses: ['1 Corinthians 6:19-20', 'Ecclesiastes 10:17', '1 Timothy 4:4-5'], reflection: 'Timing, quality and rest are stewardship, not a rule imposed on anyone; the Word keeps the conscience free (Romans 14) while the science informs the choice made with a physician.' },
    quiz: { questions: [
