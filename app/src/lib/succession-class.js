...
export const SUCCESSION_MODULES = [
  {
    ...
    benefits: [
      'You leave holding the honest sentence most succession plans avoid: "And who knoweth whether he shall be a wise man or a fool? yet shall he have rule over all my labour wherein I have laboured" (Ecclesiastes 2:19). The builder does not get to decide, and the heir rules either way.',
      'You stop trying to hand down a map. The founder fought battles the heir will never fight, and the heir will meet problems the founder never met — so a copied path is not caution, it is a plan to be wrong.',
      'You know what CAN transfer, which is the whole point of the course: "Wisdom is the principal thing; therefore get wisdom: and with all thy getting get understanding" (Proverbs 4:7). Understanding and character travel; a script does not.',
      'You keep the order this house runs on, so prosperity never gets ahead of the person: "I wish above all things that thou mayest prosper and be in health, even as thy soul prospereth" (3 John 1:2). The soul sets the pace.',
      'You hear the charge Darrell actually gave when he asked for this course — we cannot expect our heirs to learn how we did, because there are new issues the older generation wants the younger to take care of.',
      'Carry it out this session: look at how much the family businesses have already changed in a few years. The heir will steward tools and problems that did not exist when the founder began, which is the proof the map cannot simply be copied.',
    ],
  ...
  },
  {
    ...
    benefits: [
      'You leave with the sequence in the right order: an heir does not begin by managing money, they begin by learning to READ it — and on the real books, because a toy example teaches nothing true.',
      'You understand why the seat is read-only on purpose. You see the real accounts, the real forecast, the real tithe and buffer, and you can trace where a number came from, but you cannot change anything yet. Read, do not wreck.',
      'You have the biggest handoff in the Old Testament as the pattern, and you notice what David led with: "know thou the God of thy father, and serve him with a perfect heart and with a willing mind" (1 Chronicles 28:9) — the heart before the blueprints.',
      'You know what the promise attached to it is, and it is conditional: "if thou seek him, he will be found of thee" (1 Chronicles 28:9). Seeking is the heir’s part.',
      'You know why a read-only season is not a waiting room but a proving ground: "He that is faithful in that which is least is faithful also in much" (Luke 16:10). Faithfulness in the least is what earns the much.',
      'Carry it out this session: open the family books in the read-only view and trace ONE real number all the way back to where it came from. You are reading the truth of the house, which is a privilege handled with care.',
    ],
  ...
  },
  {
    ...
    benefits: [
      'You leave able to see what David actually did with the end of his reign: he GATHERED gold, silver, bronze, timber, cut stone and skilled workers for a house he would never raise himself.',
      'You hear everything packed into the handoff verse: "Solomon my son, whom alone God hath chosen, is yet young and tender, and the work is great: for the palace is not for man, but for the LORD God" (1 Chronicles 29:1). Chosen, young, and given a GREAT work — for Yahweh rather than for a man.',
      'You notice what is NOT in that verse, which is the lesson: no expectation that Solomon repeat David’s life. David’s work was war; Solomon’s was building, in a peace those wars had bought.',
      'You carry the charge that stands over a new builder taking up a new work: "the LORD hath chosen thee to build an house for the sanctuary: be strong, and do it" (1 Chronicles 28:10).',
      'You keep the long horizon that makes gathering rational: "A good man leaveth an inheritance to his children’s children" (Proverbs 13:22). Two generations out, not one.',
      'Carry it out this session: name one thing the family is building NOW so the next generation can complete it later — a fund, a system, a property, a skill. You are watching David gather in real time.',
    ],
  ...
  },
  {
    ...
    benefits: [
      'You leave knowing some works genuinely cannot be finished by the generation that prepared them — not for lack of faith or effort, because Moses lacked neither, but because the crossing itself was assigned to the next leader.',
      'You have the public commissioning as a model for how a handoff should be done: "Be strong and of a good courage: for thou must go with this people unto the land which the LORD hath sworn unto their fathers to give them" (Deuteronomy 31:7), said in the sight of all Israel rather than privately.',
      'You know where the successor’s courage is anchored, and it is not in talent: "the LORD, he it is that doth go before thee; he will be with thee, he will not fail thee, neither forsake thee" (Deuteronomy 31:8).',
      'You hear Yahweh say it again directly, after the predecessor is gone: "Moses my servant is dead; now therefore arise, go over this Jordan" (Joshua 1:2). The death of the founder is not the end of the assignment; it is the start of yours.',
      'You carry the command that covers the fear an heir actually feels: "Be strong and of a good courage; be not afraid, neither be thou dismayed: for the LORD thy God is with thee whithersoever thou goest" (Joshua 1:9).',
      'Carry it out this session: identify an edge the family has reached but not crossed — a goal prepared for and not yet entered. That crossing may be yours to lead, with the same God who went before the founder going before you.',
    ],
  ...
  },
  {
    ...
    benefits: [
      'You leave with the ambition a faithful successor is allowed to have. Offered anything, Elisha asked "let a double portion of thy spirit be upon me" (2 Kings 2:9) — not comfort, and not safety.',
      'You know why that was not arrogance: a double portion was the firstborn’s inheritance, so he was asking to receive as a true heir and to do more than his teacher. A successor refuses to let the mission shrink on their watch.',
      'You carry the handoff instruction with its generations intact: "the things that thou hast heard of me among many witnesses, the same commit thou to faithful men, who shall be able to teach others also" (2 Timothy 2:2). Paul, Timothy, faithful men, others also — four links in one sentence.',
      'You see what breaks the chain, which is the real failure mode: receiving the inheritance and never committing it forward.',
      'You hold the horizon the Word sets for a steward rather than an owner: "A good man leaveth an inheritance to his children’s children" (Proverbs 13:22). Succession is a chain, not a finish line.',
      'Carry it out this session: write the hand-forward plan — what you are learning now, and who you will one day teach it to. Planning to hand it on again is what makes you a steward of the chain rather than of your own turn.',
    ],
