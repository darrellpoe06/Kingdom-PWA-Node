...
export const HELP = {
  ...
  'books:debts': {
    title: 'Debts',
    tag: 'What is owed, with a payoff (snowball) plan.',
    what: 'Debts tracks every balance you owe and builds a payoff plan. It can order them smallest-first (the snowball) and show how adding a little extra each month shortens the road to free.',
    how: [
      'Add each debt with its balance, rate, and minimum payment.',
      'Set an extra-payment amount to see the payoff date move.',
      'Switch the sort to compare snowball order against highest-rate-first.',
    ],
    why: 'Debt is the weight that limits choices. Seeing the plan — and the finish line — turns a vague dread into a path you can walk.',
    section: 'money',
  },
  'books:transactions': {
    title: 'Transactions',
    tag: 'The living record of money in and out.',
    what: 'Transactions is the line-by-line ledger of money moving in and out. Each one is a versioned living record — you can edit it and see its history — and every balance in the app is built from these entries.',
    how: [
      'Add a transaction with its date, amount, account, and category.',
      'Filter by entity to see just one set of books.',
      'Edit an entry and its full change history is kept, so nothing is silently rewritten.',
    ],
    why: 'This is the ground truth of your finances. Get these right and everything downstream — balances, forecasts, reports — is right too.',
    section: 'money',
  },
  'books:imported': {
    title: 'Imported',
    tag: 'Transactions pulled in from outside, waiting to be filed.',
    what: 'Imported holds transactions that came in from an outside source (a bank feed or upload) and are waiting for you to confirm and categorize them before they join your books.',
    how: [
      'Review each imported row and confirm or correct its category and entity.',
      'Accept the ones that are right; fix the ones that need a touch.',
      'Once filed, they become normal transactions in your ledger.',
    ],
    why: 'A review step between "the bank said" and "our books say" keeps junk out and keeps you in control of what counts.',
    section: 'money',
  },
  'books:cart': {
    title: 'Subscriptions',
  ...
  succession: {
    ...
    tag: 'Map who receives what — then hand the attorney a package.',
    what: 'Family Succession maps every real asset — properties, accounts, and each business/LLC interest — to its owning entity, the intended beneficiary, and the Illinois transfer instrument that applies (a TODI, a trust, LLC operating-agreement succession, or a POD/TOD designation). It flags any asset with no plan as probate exposure and builds an organized package your estate attorney executes from. It documents and organizes your plan; it is not legal advice and does not execute any transfer.',
    how: [
      'Open the Asset Map and, for each asset, set the intended beneficiary and choose the instrument (the surface suggests which one typically applies).',
      'Check the Gaps tab — it highlights anything with no plan, especially real property that would otherwise go through probate.',
      'Read the Instruments tab to understand each Illinois instrument, cited to the statute.',
      'Export the Attorney Package and take it to a licensed Illinois estate attorney to make it binding.',
    ],
    why: 'A multi-entity family loses control of its assets at death if there is no plan — probate is public, slow, and costly. Mapping who gets what, by which instrument, protects the family and gives the attorney a running start.',
    when: 'Work it whenever ownership changes — a new property, a new entity, a birth — and review it before every attorney meeting.',
    more: 'How an asset is held decides the instrument: property titled personally can use a TODI, but property titled in an LLC cannot — it transfers at the membership-interest level instead. The surface encodes that distinction and flags every legal specific for the attorney to confirm.',
    section: 'money',
  },
  admin: {
    title: 'Admin',
