...
export const AI_LEGAL_BLUEPRINT_MODULES = [
  // ---------------------------------------------------------------------------
  {
    ...
    benefits: [
      'You leave with one picture that protects you for the rest of your life: a vendor chatbot is a stranger’s computer. It does not run on your phone or in your house, and what you type travels to servers you do not own.',
      'You know what the consumer terms actually allow — your words stored, a sample read by a human reviewer, and your text used to train the next version of the model unless you went out of your way to turn that off.',
      'You know the part that surprises almost everyone, and it is documented rather than rumoured: pressing delete does not guarantee the words are gone. In the New York Times case a United States court ordered chat logs PRESERVED, including chats users had deleted.',
      'You carry one rule small enough to keep: if you would not be fine seeing it on a billboard, it does not go into a chatbot.',
      'You have the Lord’s own warning for exactly this shape of risk: "there is nothing covered, that shall not be revealed; neither hid, that shall not be known" (Luke 12:2) — and the wisdom that answers it, "A prudent man foreseeth the evil, and hideth himself" (Proverbs 22:3).',
      'Carry it out this session: open our own A.I. and read the on-screen promise, then hold the two pictures side by side — into a vendor, your words leave the house; into ours, they do not.',
    ],
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    benefits: [
      'You leave able to recite the nine categories, which is the whole cheat-sheet: who you are, ID numbers, money, health, passwords and keys, work secrets, anything from a lawyer, other people’s information, and children’s information.',
      'You know which two catch good people most often — money and health — because both arrive disguised as a kindness: help me budget, and a prayer request that names what somebody is sick with.',
      'You understand that the danger is the combination, not only the single field. A full name tied to an address or a birth date is regulated personal information even though neither half feels secret alone.',
      'You know what to do if a secret has already gone in: treat it as exposed and change it. A password pasted once is a password to rotate, not a password to hope about.',
      'You carry the Word on holding what is not yours to spill: "A talebearer revealeth secrets: but he that is of a faithful spirit concealeth the matter" (Proverbs 11:13), and "Keep thy heart with all diligence" (Proverbs 4:23). Keeping the list is keeping a trust — your own, and other people’s.',
      'Carry it out this session: read the nine aloud once. Naming each category is how it sticks, and the pause it buys you is the entire protection.',
    ],
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    benefits: [
      'You leave with a mechanism instead of a vague worry. On consumer tiers three things happen by default: your input is RETAINED, a sample may be subject to HUMAN REVIEW, and your content may be used to TRAIN the next model.',
      'You carry the two honest caveats about opting out, which most advice leaves off: it generally stops only FUTURE use rather than deleting what was already kept, and a short abuse-monitoring window typically remains regardless.',
      'You know the single biggest factor is the TIER, not the brand. Free and personal accounts are the permissive default; business, school, enterprise and developer tiers commonly promise no training, add real data-processing contracts, and sometimes offer zero retention.',
      'You know what only the higher tier can give you, which matters the moment health information is involved: the contract the law requires. Same name on the door, very different rules inside.',
      'You have the posture the Word puts on exactly this: "The simple believeth every word: but the prudent man looketh well to his going" (Proverbs 14:15). Reading what a tool does with your words IS looking well to your going.',
      'Carry it out this session: open our own A.I. and say its promise back in your own words — it runs on our machine, and we do not sell your data. That is the opposite of the consumer default, and the reason it was built.',
    ],
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    benefits: [
      'You leave able to say WHY each item is on the list, which is what makes the rule stick when it is inconvenient — and you leave knowing this is educational and not legal advice, because a real situation calls for a licensed attorney.',
      'You know health information is not protected there. HIPAA covers it when a covered entity or a business associate under a signed agreement handles it, and a consumer chatbot is neither and will not sign that contract.',
      'You know a lawyer’s material can lose the very thing that made it safe. Privilege depends on confidentiality, so handing it to an outside vendor can waive it — and a court has already found a user had no reasonable expectation of confidentiality in a chatbot’s terms.',
      'You know a company secret keeps trade-secret status only while reasonable measures keep it secret, so pasting it into a public tool can forfeit that protection and may breach an agreement on top.',
      'You know the headlines are real rather than cautionary fiction, including engineers leaking source code in 2023 and a national regulator banning and fining a service.',
      'You carry the Word’s own frame for obeying the law that protects people: "Every prudent man dealeth with knowledge: but a fool layeth open his folly" (Proverbs 13:16), and "Let every soul be subject unto the higher powers" (Romans 13:1). Respecting these protections is part of loving your neighbour.',
    ],
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    benefits: [
      'You leave with the pause rehearsed in ordinary moments, because a rule only protects you where it actually shows up — the get-well card, the argument, the budget, the directory, the work file.',
      'You can name what is wrong in each and the safe version of it: the card written generically or on our own A.I.; the friend’s address simply not pasted; the statement asked about without the numbers; the roster never uploaded; the work file kept to an approved, contracted tool.',
      'You see the one that is worst and why it does not feel worst: the church directory. One paste exposes an entire congregation’s regulated personal data in a single action.',
      'You carry three moves rather than a vague caution — stop, then redact, then choose the right tool. The stop is the part that does the work.',
      'You have the wisdom the Word offers for exactly this pause: "A prudent man foreseeth the evil, and hideth himself" (Proverbs 27:12), and where to get it, "If any of you lack wisdom, let him ask of God, that giveth to all men liberally" (James 1:5).',
      'Carry it out this session: take three real tasks you actually do and sort them out loud — safe as-is, needs redacting, or must stay on our own A.I. Then confirm the private ones never go to a vendor.',
    ],
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    benefits: [
      'You leave with the blueprint on one card: redact before you paste, never paste live secrets, match the tool to the sensitivity, and configure whatever you do use.',
      'You know redaction means generalising, not just deleting one field, because a combination of ordinary details can still identify a person.',
      'You can match a task to a tool without agonising. Genuinely public, hypothetical or de-identified work is fine anywhere; regulated or confidential work needs a contracted tier — or best of all, hardware you own.',
      'You see the structural point the whole course was building toward: retention, human review, training on your words, the lost HIPAA protection, the waived privilege, the forfeited trade secret, the regulator actions — every one of them has the SAME cure. If the data never leaves your premises, there is no third party to store it and no reviewer to read it.',
      'You carry the commission the Lord gives for living wisely among real risks: "be ye therefore wise as serpents, and harmless as doves" (Matthew 10:16) — wisdom and innocence together, never one without the other.',
      'Carry it out this session: do one real sensitive task on our own A.I. that you would never do on a vendor chatbot, and feel the difference — it never left the house. Then teach the one rule to one person; "the same commit thou to faithful men, who shall be able to teach others also" (2 Timothy 2:2) is how you prove you own it.',
    ],
