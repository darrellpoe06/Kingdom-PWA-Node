...
export const DOOR_PHASES = [
  ...
  makeDoorPhase({
    ...
    detail: 'The Moore pattern applied and SHIPPED (DR-0174): public/lovecorner/index.html is the church-tagged entry page (a texted link previews as THE CHURCH, then meta-refreshes into ?view=church); manifest-lovecorner.webmanifest carries the church\'s own name so Add-to-Home-Screen installs "The Love Corner"; /church + /thelovecorner are the share aliases. The app icon is the CHURCH\'S OWN official logo (the Church of the Living God round emblem — gold cross, red heart, dove, CGLG monogram, 1946 — supplied by Darrell 2026-07-12, rendered to 192/512 any + maskable so Android\'s adaptive mask never clips the ring); the texted-link preview shows it too. Cleared to open — approved by the church, going live for the congregation ahead of the National Assembly.',
