...
const PATHS = [
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    opening: [
      { id: 'dar-valley', type: 'word', stage: 'Young Adult', title: 'Valley Homes & Horizon Homes', body: 'Born in Valley Homes — the Turnkey projects at 25th & 11th in Rock Island (Census Tract 237) — and moved on to Horizon Homes in Davenport (Tract 126.02) when his mother relocated the family. Two tracts the maps skip, one on each side of the river, each about one in five below the poverty line and nearly a third of its children — in a region that lost more than half its factory jobs. But the God who sees was already there.', lens: 'Yahweh raises the poor out of the dust and lifts the needy from the ash heap, to seat them with princes — the projects were a starting line, never a sentence. To Him be the glory.', scripture: { ref: 'Deuteronomy 8:2' }, effects: { faith: 1, family: 1 } },
      { id: 'dar-champaign', type: 'word', stage: 'Young Adult', title: 'Champaign — A Wife, and a Daughter Made Whole', body: 'He comes to Champaign already a young father — his daughter K’Shawna, born when he was seventeen, still in the wilderness. He climbs the Rent-A-Center ladder to get here — Davenport, then the Quad Cities stores in Moline, East Moline and Rock Island, his first store as general manager in Danville — a store two years without a profit, until he changed how the team worked together and, in the very first month, Yahweh let it turn a profit — and on that fruit he is promoted up to the bigger Champaign store — and steadies with community college at Parkland. And here Yahweh sets the cornerstone of the whole house — he meets Bishop Gwin and marries his daughter Christina, who takes K’Shawna as her own. By seven she is theirs in law and in love — now our daughter, full stop. Twenty years now.', lens: 'This is the Spirit of adoption in a real house: he received Christina as his wife, and she received his daughter as her own — a covenant family rose where the wilderness had left a boy alone. Grace does not only forgive the past; it adopts it.', scripture: { ref: 'Romans 8:15' }, effects: { family: 2, faith: 1, joy: 1 } },
      { id: 'dar-build', type: 'word', stage: 'Building Years', title: 'The Builder & the Books', body: 'Before the books, his business foundation was laid at Rent-Way — the Quad Cities rival he worked before Rent-A-Center, whose systems were so much better they taught him the what, the why and the when of a business (Rent-A-Center later bought Rent-Way and kept those very systems). There, sent store to store to teach collections, his word to the staff was "everyone can do this" — then he ran their routes himself, reaching customers no one had touched in ninety days that same day, and left each store collecting past ninety percent. The gift was never to be indispensable; it was to make others able. And the customers knew him: when he moved to another store, they followed him there — because he did right by them no matter what, and they knew it. Then the disciplined climb of the books — an MBA in IT management, the PMP and ITIL — and PoeTech founded to build sovereign technology that serves families instead of extracting from them, real estate stewarded. He commits the work to Yahweh before the lights come on.', lens: 'Commit your works to Yahweh and your plans are established; the builder who builds with Him does not labor in vain, and the increase is His.', scripture: { ref: 'Proverbs 16:3' }, effects: { provision: 1, wisdom: 1, faith: 1, service: 1 } },
      { id: 'dar-legacy', type: 'word', stage: 'Establishing', title: 'Before Kings, Pouring Back', body: 'A software project manager at the University of Illinois by day; landlord, founder and builder by calling. The boy from the projects now stands in rooms he was never counted to reach — and he pours it back: raising his children — K’Shawna, Christiana, and the twins Darrell (Christian) and Christyn — in the Way, and running the technology for The Church of the Living God, pastored by Bishop Gwin — his father in love, not merely in law: a true father in the faith, who became family.', lens: 'See a man diligent in his business — he shall stand before kings; a good man leaves an inheritance to his children’s children. None of it by his own hand — to Yahweh be the glory.', scripture: { ref: '2 Timothy 2:2' }, effects: { provision: 1, souls: 1, family: 1, faith: 1 } },
    ],
  },
  {
    id: 'college',
