...
const PATHS = [
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    opening: [
      ...
      { id: 'dar-legacy', type: 'word', stage: 'Establishing', title: 'Before Kings, Pouring Back', body: 'A software project manager at the University of Illinois by day; landlord, founder and builder by calling. The boy from the projects now stands in rooms he was never counted to reach — and he pours it back: raising his children — K’Shawna, Christiana, Darrell (Christian) and Christyn — in the Way, and running the technology for The Church of the Living God, pastored by Bishop Gwin — his father in love, not merely in law: a true father in the faith, who became family.', lens: 'See a man diligent in his business — he shall stand before kings; a good man leaves an inheritance to his children’s children. None of it by his own hand — to Yahweh be the glory.', scripture: { ref: '2 Timothy 2:2' }, effects: { provision: 1, souls: 1, family: 1, faith: 1 } },
    ],
  },
  {
    id: 'college',
