...
const PATHS = [
  {
    ...
    opening: [
      ...
      { id: 'prj-low', type: 'word', stage: 'The Wilderness', title: 'The Low Place — A True Wilderness', body: 'This one is real. This platform’s founder was born in Valley Homes — the Turnkey public housing at 25th & 11th in Rock Island, later declared "severely distressed" and torn down — and raised on to Horizon Homes in Davenport, inside a Quad Cities that lost 55% of its factory jobs. The Census Bureau still calls it Tract 237: about one in five below the poverty line, and nearly a third of its children — and he was one of those children. The block a map skips over, the odds a report already wrote off. But the God who sees was already there — and He still raised him to a table.', lens: 'The wilderness here is not a metaphor — it is a measured place a boy was carried out of. What Yahweh did once, He does again; He raises the poor from the dust to seat them with princes.', scripture: { ref: 'Deuteronomy 8:2' }, effects: { character: 1, faith: 1 } },
