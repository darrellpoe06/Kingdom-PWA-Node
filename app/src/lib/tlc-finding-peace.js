...
export const FINDING_PEACE_CHAPTERS = [
  ...
  },
  {
    ...
    standard: V('Philippians 4:6') + ' ' + V('Philippians 4:7') + ' Instead of stewing in worries, flip the script and turn concerns into prayers. Practical tip: a worry jar — write anxieties down and offer them to God in prayer, and watch Him replace them with His peace. ' + V('Philippians 4:8') + ' Practical tip: a gratitude journal shifts focus from the negative to the positive. ' + V('Philippians 4:13') + ' Practical tip: when faced with a daunting challenge, take a deep breath, square your shoulders, and say it aloud — then go forward, trusting His process even when you cannot see where He is taking you.',
