...
export const LEGACY_PROVISIONS_META = {
  ...
  format: 'Self-paced · 6 lessons · read one a week or all in an afternoon · paced to your age',
  cadenceDays: 7,
  weeks: 6,
