...
export const LEGACY_PROVISIONS_MODULES = [
  {
    ...
    benefits: [
      'You leave able to answer the question every family gets wrong. Taxes are real and a good structure answers them, but what empties an estate is a transfer of BALANCE without a transfer of FORMATION.',
      'You can read the two indictments inside one sentence: "riches kept for the owners thereof to their hurt" (Ecclesiastes 5:13) — held and hoarded rather than stewarded — and then "he begetteth a son, and there is nothing in his hand" (Ecclesiastes 5:14).',
      'You know the speed problem has its own verse: "An inheritance may be gotten hastily at the beginning; but the end thereof shall not be blessed" (Proverbs 20:21). Fast arrival is itself a risk factor.',
      'You have the whole arc in one line about a full share and an unformed heart: "the younger son gathered all together, and took his journey into a far country, and there wasted his substance with riotous living" (Luke 15:13).',
      'You notice what none of those texts blame — not the size of the estate and not the tax code. The failure is upstream of the money, in the heir and in what was or was not transferred alongside the account.',
      'Carry it out this session: open the Legacy Provisions system and read the articles our house has already written, and name what is being handed down beside every dollar — a mission, a standard, and a way of deciding.',
    ],
  ...
  },
  {
    ...
    benefits: [
      'You leave knowing what the first provision costs and what it decides: nothing legally, and almost everything practically.',
      'You can say why a legally binding instrument is not enough. The trust moves assets and cannot transmit judgment — a trustee who never met the founder, an heir born after he died, a spouse marrying in thirty years from now can each read exactly what they receive and learn nothing about why any of it was built.',
      'You have Yahweh’s own method for generational transfer, and it starts in the parent rather than the child: "these words, which I command thee this day, shall be in thine heart" (Deuteronomy 6:6), and only then "thou shalt teach them diligently unto thy children" (Deuteronomy 6:7).',
      'You notice where He puts the teaching — in the ordinary hours, not a ceremony: "when thou sittest in thine house, and when thou walkest by the way, and when thou liest down, and when thou risest up" (Deuteronomy 6:7).',
      'You have the public declaration that makes a household’s standard unmistakable: "but as for me and my house, we will serve the LORD" (Joshua 24:15), and the operational reason for writing rather than merely intending it, "Write the vision, and make it plain upon tables, that he may run that readeth it" (Habakkuk 2:2).',
      'Carry it out this session: read our constitution article by article with the Scripture each stands on, and attest the ones you have read. What is unattested shows as unattested — the surface never assumes it was read.',
    ],
  ...
  },
  {
    ...
    benefits: [
      'You leave with the right threat model, which is where most families start wrong. Walk through how estates actually leave a family and you find a lawsuit, creditors after a business failure, a divorce, a partnership signed without counsel — and every one of them takes the asset through a PERSON.',
      'You understand the mechanism rather than the label. The assets stay owned by the trust; the beneficiary holds a right to receive under its terms, not title, and cannot assign or pledge that interest away — so a creditor who could reach what a debtor owns has a far harder path.',
      'You know the limits plainly, which is what keeps a family from being shocked at the worst moment: protection is strongest when someone else funded the trust for you and weak or void where you funded it for yourself, child support and certain government claims commonly pierce it, and a distribution already received is the beneficiary’s own property.',
      'You see that Yahweh legislated a wall around an inheritance Himself: "So shall not the inheritance of the children of Israel remove from tribe to tribe" (Numbers 36:7), grounded in whose land it actually is — "The land shall not be sold for ever: for the land is mine; for ye are strangers and sojourners with me" (Leviticus 25:23).',
      'You can answer the charge that a wall is distrust: "A prudent man foreseeth the evil, and hideth himself" (Proverbs 22:3). Foresight is commended, not apologised for.',
      'Carry it out this session: walk the real exposure questions for our house one at a time and record the honest answer — verified, exposed, or not yet reviewed. Nothing reads protected because we assumed it.',
    ],
  ...
  },
  {
    ...
    benefits: [
      'You leave knowing which provision changes who the heir BECOMES: the requirement that beneficiaries do not simply take distributions but learn to produce, build, invest and contribute value back into the trust.',
      'You can name what the alternative quietly trains. An heir who receives on a schedule and produces nothing learns over years that money arrives without being made — formed, gently and expensively, into a consumer of the very thing handed to him to steward.',
      'You have the parable read correctly, which most people do not: the condemned servant did not lose money. He kept it perfectly safe and returned exactly what he was given — "Thou wicked and slothful servant" (Matthew 25:26), "Thou oughtest therefore to have put my money to the exchangers" (Matthew 25:27). Preservation was not faithfulness.',
      'You carry the standing charge in its active form: "Occupy till I come" (Luke 19:13).',
      'You know work is original equipment rather than a penalty. Before there was a single curse in the world, "And the LORD God took the man, and put him into the garden of Eden to dress it and to keep it" (Genesis 2:15); and Paul kept the house rule blunt, "if any would not work, neither should he eat" (2 Thessalonians 3:10).',
      'Carry it out this session: open the production ledger and look at the real entries. Standing is computed from entries and never assumed — with none yet, the surface says exactly that, which is not a passing score.',
    ],
  ...
  },
  {
    ...
    benefits: [
      'You leave with the lesson written for the person LIVING the provisions rather than the one writing them — because from inside, every clause can read as an accusation.',
      'You can take the answering sentence apart: "the heir, as long as he is a child, differeth nothing from a servant, though he be lord of all" (Galatians 4:1). He IS the heir, that is settled; the estate is genuinely his, present tense; and he still looks from outside like a servant.',
      'You know the constraint is a description of where he is in time rather than a verdict on his worth: "But is under tutors and governors until the time appointed of the father" (Galatians 4:2).',
      'You hear the duty that clause puts on the PARENT, which is the half families skip: appoint the time. A structure with no path to release stops being formation and becomes control, and it produces exactly the resentful heir it meant to prevent.',
      'You know how the season advances, and it is not by waiting: "He that is faithful in that which is least is faithful also in much: and he that is unjust in the least is unjust also in much" (Luke 16:10).',
      'Carry it out this session: read your own standing — which articles you have attested, what production is on record for you, and what the trust requires next. It is honest about what is not there yet, which is what makes it worth reading.',
    ],
  ...
  },
  {
    ...
    benefits: [
      'You leave able to name the one fight every clause in this course was forged in: how far may one generation reach forward to bind the use of what it hands on?',
      'You know Yahweh answered it first and answered it on BOTH sides. The wall: "The land shall not be sold for ever: for the land is mine; for ye are strangers and sojourners with me" (Leviticus 25:23). The release: "ye shall return every man unto his possession, and ye shall return every man unto his family" (Leviticus 25:10).',
      'You know there is a way home for the one who lost ground, and that it was exercised in real history — "the right of redemption is thine to buy it" (Jeremiah 32:7), the word that sent Jeremiah to buy a field in a besieged country.',
      'You carry the shape of the answer: a wall that never opens is not His pattern; a wall plus a jubilee is.',
      'You can place the common law’s own story beside it — land transferred to a trusted holder by men leaving on crusade, holders who refused to give it back, a court that enforced the arrangement in conscience, a king who struck at it in 1535 because it cost him his fees, and lawyers who found the holes within a generation.',
      'You hold the sentence that keeps a modern family humble about all of it: "there is no new thing under the sun" (Ecclesiastes 1:9). Knowing the fight is how you use the tool instead of being used by it.',
    ],
  ...
  },
  {
    ...
    benefits: [
      'You leave knowing the transfer was never designed to stop with the people who receive it.',
      'You can count the links in one breath of the psalm: "he commanded our fathers, that they should make them known to their children" (Psalms 78:5), "That the generation to come might know them, even the children which should be born; who should arise and declare them to their children" (Psalms 78:6). Four generations, and every link ARISES and declares.',
      'You see the same architecture in the church: "the same commit thou to faithful men, who shall be able to teach others also" (2 Timothy 2:2). The deposit goes specifically to people able to hand it forward.',
      'You notice Solomon sets the money at the same distance as the teaching: "A good man leaveth an inheritance to his children’s children" (Proverbs 13:22) — grandchildren, which means a plan aimed only at your children is aimed one generation short of the text.',
      'You have the teaching order for your own table: the constitution first because principles are what actually travel, the wall second so a child understands it as love with foresight rather than suspicion, and the production requirement third so the heir is formed into someone who adds.',
      'Carry it out this session: export the constitution and the provisions summary. Another family can start from ours, replace our articles with their own, and run the same system for their house — inside this app, at no cost.',
    ],
