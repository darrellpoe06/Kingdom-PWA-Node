...
export const LIVING_LESSONS_MODULES = [
  ...
  // "in the measure of every part." Verses KJV, VERBATIM (DR-0076). Grace-centered.
  {
    ...
    anchor: { ref: '1 Corinthians 12:25-26; Galatians 6:2', theme: 'No schism in the body — the members have the same care one for another; whether one member suffer, all the members suffer with it, or one member be honoured, all rejoice with it. Bear ye one another’s burdens, and so fulfil the law of Christ. The connected chain is the design: tend the weak link, in your frame and in the Body.' },
  ...
  {
    id: 'll15-seasoned-with-salt',
    title: 'Seasoned with Salt (the science of conversation meets the Word)',
    // Harvested 2026-07-10: a conversation with Prof. Alison Wood Brooks
    // (Harvard behavioral scientist; "Talk: The Science of Conversation and
    // the Art of Being Ourselves") — anxiety reframed as excitement, the
    // conversational compass, the TALK framework (Topics · Asking · Listening
    // · Kindness), group airtime, and concise digital writing. The lab keeps
    // rediscovering what the Word commanded first; this lesson pairs the
    // science witness with Scripture's own conversation algorithms — and it
    // doubles as the conduct standard for Ari, the PoeTech App AI (DR-0141).
    anchor: { ref: 'Colossians 4:6; James 1:19; Proverbs 20:5', theme: 'Let your speech be alway with grace, seasoned with salt, that ye may know how ye ought to answer every man; swift to hear, slow to speak; and counsel in the heart is deep water — a man of understanding will draw it out. The Word wrote the conversation manual first; the lab is catching up.' },
    bigIdea: 'A Harvard behavioral scientist spent a career measuring what makes conversations work, and the findings land almost verse by verse on what the Word already commanded. Her TALK framework: choose TOPICS well — Scripture: "A word fitly spoken is like apples of gold in pictures of silver" (Proverbs 25:11), "a word spoken in due season, how good is it!" (Proverbs 15:23). ASK real follow-up questions — the research finds question-askers are better liked and learn more; Scripture: "Counsel in the heart of man is like deep water; but a man of understanding will draw it out" (Proverbs 20:5) — asking IS drawing out the deep water. LISTEN before you answer — the research distinguishes real listening from waiting to talk; Scripture said it with an edge: "He that answereth a matter before he heareth it, it is folly and shame unto him" (Proverbs 18:13), "let every man be swift to hear, slow to speak" (James 1:19). And KINDNESS as the frame of it all — the research calls respect and empathy non-negotiable; Scripture: "Let no corrupt communication proceed out of your mouth, but that which is good to the use of edifying, that it may minister grace unto the hearers" (Ephesians 4:29), "A soft answer turneth away wrath" (Proverbs 15:1). Even her anxiety finding — that nerves and excitement are the same arousal, and naming it rightly changes the outcome — walks beside the Word: God\u2019s Spirit gives "power, and of love, and of a sound mind," not fear (2 Timothy 1:7), and the believer is told to be "ready always to give an answer... with meekness" (1 Peter 3:15) — prepared, not panicked. The science describes the machinery; the Word supplies the heart AND the guardrail: these moves are LOVE\u2019s tools, never manipulation\u2019s — "seasoned with salt" (Colossians 4:6) means preserving and flavoring the other person, not seasoning your own advantage.',
    inApp: 'Run ONE conversation this week on the Word\u2019s TALK: pick the topic that serves the other person (Proverbs 25:11), ask two real follow-up questions and draw out the deep water (Proverbs 20:5), do not answer until you have actually heard (Proverbs 18:13), and keep every word edifying (Ephesians 4:29). Before it starts, if you feel the nerves — name the truth out loud: "God gave me power, love, and a sound mind" (2 Timothy 1:7). Afterward, note what changed.',
    benefits: [
      'A biblical conversation toolkit the lab has now verified — topics in season, questions that draw out, hearing before answering, grace that edifies.',
      'The anxiety reframe under the true Name — arousal renamed by 2 Timothy 1:7 rather than by self-talk alone: prepared, not panicked (1 Peter 3:15).',
      'Protection from the counterfeit — technique without love is manipulation; "seasoned with salt" seasons the OTHER person\u2019s good (Colossians 4:6).',
      'Group grace — sharing the airtime is "swift to hear, slow to speak" (James 1:19) practiced in a room, not just a pair.',
      'Cleaner digital speech — short, structured, kind messages are Proverbs 25:11 applied to a screen.',
    ],
    levels: {
      child: 'Did you know scientists study how to have good conversations? And guess what they found — the same things God\u2019s Word already says! Here is the secret, called TALK: T — talk about things the other person cares about. A — ASK questions! When your friend tells you something, ask "and then what happened?" People love it when you really want to know. L — LISTEN all the way. The Bible says answering before you listen is silly (Proverbs 18:13), so hear the WHOLE story first. K — be KIND with your words. The Bible says our words should be like salt on food — they should make things better (Colossians 4:6)! And if talking to new people makes your tummy feel nervous and fluttery — that same flutter is what excitement feels like! God did not give you a spirit of fear; He gave you power, love, and a calm strong mind (2 Timothy 1:7). So next time, say "I\u2019m excited!", ask good questions, listen big, and be kind.',
      senior: 'For the seasoned believer, this lesson is a quiet vindication: a Harvard laboratory, after years of coded conversations, has arrived at Proverbs. The TALK findings map onto Scripture with almost embarrassing precision — topic selection onto the word "fitly spoken" and "in due season" (Proverbs 25:11; 15:23); the power of follow-up questions onto the man of understanding who "will draw it out" of deep water (Proverbs 20:5); real listening versus performative agreement onto "he that answereth a matter before he heareth it" (Proverbs 18:13) and James\u2019s "swift to hear, slow to speak" (James 1:19); and kindness as the load-bearing wall onto "that it may minister grace unto the hearers" (Ephesians 4:29). Two places deserve a senior\u2019s discernment. First, the anxiety reframe ("I am excited") is real physiology honestly used — but the believer\u2019s reframe is anchored deeper than self-talk: "God hath not given us the spirit of fear" (2 Timothy 1:7), and readiness "with meekness and fear" (1 Peter 3:15) is the prepared calm the technique only approximates. Second, the guardrail: conversational skill divorced from love curdles into influence-craft — the same moves that draw a soul out can work a room for advantage. "Seasoned with salt" (Colossians 4:6) is a covenant standard: salt preserves the OTHER; the aim of every technique here is to know how to answer EVERY man — including the one who can do nothing for you. Teach these skills to the grandchildren deliberately; a generation raised on screens is losing exactly what this lesson trains, and the Body should be where they relearn it.',
    },
    quiz: {
      questions: [
        { q: 'The research says asking follow-up questions makes people feel known and draws out what matters. Which verse commanded that move first?', options: ['Proverbs 20:5 — counsel is deep water, and a man of understanding will draw it out', 'Genesis 1:1', 'Psalm 23:1'], answer: 0, explain: 'Asking real questions IS drawing out the deep water — the lab verified the proverb.' },
        { q: 'What does Scripture call answering before you have really heard?', options: ['Efficiency', 'Folly and shame (Proverbs 18:13) — be swift to hear, slow to speak (James 1:19)', 'Leadership'], answer: 1, explain: 'Real listening precedes the answer. The research\u2019s active-listening finding is Proverbs 18:13 with data.' },
        { q: 'You want to enjoy dinner with family (savoring); your relative wants to settle a business decision (task). The research calls the resulting frustration a quadrant mismatch. What does the Word call the remedy?',
          options: ['Talk louder', 'Discern the season — "a time to keep silence, and a time to speak" (Ecclesiastes 3:1,7) — name which time this is, and give grace when the other person is in a different one', 'Avoid family dinners'], answer: 1, explain: 'The compass is Ecclesiastes 3 drawn as a diagram. Knowing your own goal — and honoring the other person\u2019s season — dissolves most conversational frustration.' },
        { q: 'What keeps conversation skill from becoming manipulation?', options: ['Using it sparingly', 'Kindness as the frame — speech seasoned with salt that ministers grace to the HEARER (Colossians 4:6; Ephesians 4:29)', 'Never learning technique'], answer: 1, explain: 'Salt preserves the other person. Technique under love serves; technique without love works people.' },
      ],
    },
    lesson: 'The Word has always talked about talking. What is new is that the laboratory has caught up. Professor Alison Wood Brooks, a behavioral scientist at Harvard, spent years coding real conversations to find what actually works, and her framework spells TALK — Topics, Asking, Listening, Kindness. Walk it beside the Book. TOPICS: her research finds conversations live or die by what we choose to talk about and when we switch. Scripture measured that three thousand years ago: "A word fitly spoken is like apples of gold in pictures of silver" (Proverbs 25:11) — FITLY: the right word, the right moment, the right person; "a word spoken in due season, how good is it!" (Proverbs 15:23). ASKING: her data shows people who ask real follow-up questions — not topic-grabs disguised as questions — are better liked, learn more, and make others feel known. The Word named the mechanism: "Counsel in the heart of man is like deep water; but a man of understanding will draw it out" (Proverbs 20:5). Every person you meet is deep water. Asking is the bucket. LISTENING: the research distinguishes listening from waiting-to-talk, and finds that a good follow-up question is the strongest PROOF of listening there is. Scripture is blunter: "He that answereth a matter before he heareth it, it is folly and shame unto him" (Proverbs 18:13); "let every man be swift to hear, slow to speak, slow to wrath" (James 1:19) — and notice wrath sits in that verse, because most anger is un-listened pain. KINDNESS: her conclusion is that respect and empathy are not garnish but the dish. Paul wrote the standard: "Let no corrupt communication proceed out of your mouth, but that which is good to the use of edifying, that it may minister grace unto the hearers" (Ephesians 4:29) — grace TO THE HEARERS; the hearer leaves better fed. "A soft answer turneth away wrath" (Proverbs 15:1). And her second framework, the CONVERSATIONAL COMPASS, is Ecclesiastes drawn as a diagram. Her research plots every conversation on two axes — how much accurate INFORMATION must be exchanged, and how much the RELATIONSHIP is the point — giving four quadrants: CONNECTION (high information, high relationship — the deep exchange that builds a bond: Jesus at the well, and "Iron sharpeneth iron; so a man sharpeneth the countenance of his friend," Proverbs 27:17); SAVORING (low information, high relationship — being together IS the point: "a time to laugh... a time to dance," Ecclesiastes 3:4; the early church "did eat their meat with gladness and singleness of heart," Acts 2:46 — not every meal needs an agenda); PROTECTION (low information, low relationship — the boundary quadrant: "He that keepeth his mouth keepeth his life" (Proverbs 13:3), "Give not that which is holy unto the dogs, neither cast ye your pearls before swine" (Matthew 7:6), and Nehemiah\u2019s whole quadrant in one sentence: "I am doing a great work, so that I cannot come down" (Nehemiah 6:3)); and TASK/PERSUASION (high information, low relationship — the decision to be made, the matter to be reasoned: "Come now, and let us reason together, saith the LORD" (Isaiah 1:18)). Her point: we live in all four, and most conversational frustration is a QUADRANT MISMATCH — one person savoring while the other is running a task; one seeking connection while the other is rightly protecting. The Word said it first and said it shorter: "To every thing there is a season, and a time to every purpose under the heaven... a time to keep silence, and a time to speak" (Ecclesiastes 3:1,7). Discernment is knowing which time THIS is — and grace is letting the other person be in a different one without offense. Even her most famous finding has a deeper Name over it. The mechanism, precisely: anxiety and excitement are physiologically the SAME emotion — high arousal, high energy, elevated heart rate and cortisol — so the body cannot tell them apart; only the mind\u2019s label differs. Saying "I am excited" out loud performs what she calls an "excitement reappraisal": it moves the cognitive focus from threats to opportunities — from how it could go wrong to how it could go well — and that single shift measurably improves performance in public speaking, singing, and negotiation. Now hear the Word over that machinery: "For God hath not given us the spirit of fear; but of power, and of love, and of a sound mind" (2 Timothy 1:7). The believer does not merely rename the flutter; he remembers Who is in the room. And Peter\u2019s readiness — "be ready always to give an answer to every man that asketh you... with meekness" (1 Peter 3:15) — is the prepared calm every public-speaking technique is reaching for. Now the guardrail, because the same lab skills that draw out a soul can work a room: technique without love is manipulation with a syllabus. "Let your speech be alway with grace, seasoned with salt, that ye may know how ye ought to answer every man" (Colossians 4:6) — salt PRESERVES the other; the goal is to answer EVERY man well, including the one who can do nothing for you. Learn the science gladly; it is describing your Father\u2019s design. Then use it the way He does: to draw people out, hear them whole, and send them away edified. And teach it to the children on purpose — a generation being discipled by screens is losing exactly this, and the house of God should be the place they get it back.',
    facilitator: {
      talkingPoints: [
        'TALK maps onto the Word: Topics = Proverbs 25:11/15:23; Asking = Proverbs 20:5; Listening = Proverbs 18:13/James 1:19; Kindness = Ephesians 4:29/Colossians 4:6.',
        'The anxiety reframe is real physiology — and the believer\u2019s version is anchored in 2 Timothy 1:7 and 1 Peter 3:15, not self-talk alone.',
        'The guardrail: technique under love serves; technique without love manipulates. Salt preserves the OTHER (Colossians 4:6).',
        'The Conversational Compass = Ecclesiastes 3 drawn as a diagram: Connection (Proverbs 27:17), Savoring (Ecclesiastes 3:4; Acts 2:46), Protection (Proverbs 13:3; Matthew 7:6; Nehemiah 6:3), Task (Isaiah 1:18). Most frustration is a quadrant MISMATCH — name which time this is.',
        'Airtime is group-scale "swift to hear" (James 1:19) — notice who has not spoken and draw them out (Proverbs 20:5).',
        'Digital speech: short, structured, kind — Proverbs 25:11 applied to a screen.',
        'Teach it forward: the next generation is losing face-to-face conversation to screens; the Body is where they should relearn it.',
      ],
      howToRun: 'Open in prayer + read the Scripture (3): read Colossians 4:6 and James 1:19 aloud. | The big idea (10): the lab caught up to the Book — walk TALK beside the four verse-sets. | Go deeper (10): practice ONE round live — pair up; each person asks two real follow-up questions and reflects back what they heard before responding. | Reflect together (10): use the prompts; name where technique-without-love shows up. | Take it with you (2): each person picks one move (topics, asking, listening, kindness) to run all week.',
      discussionPrompts: [
        'Who in your life is "deep water" you have never really drawn out (Proverbs 20:5)? What two questions would you ask them this week?',
        'Where do you answer before you have fully heard (Proverbs 18:13) — and what does it cost the other person?',
        'The scientist says nerves and excitement are the same arousal. How does 2 Timothy 1:7 go deeper than renaming the feeling?',
        'What is the difference between speech seasoned with salt (Colossians 4:6) and speech seasoned for advantage?',
        'Who talks least in your family or group? What would sharing the airtime — swift to hear — look like at your table?',
        'Think of a recent frustrating conversation: which quadrant were YOU in (connection, savoring, protection, task) — and which was the other person in? What would naming the season (Ecclesiastes 3:1,7) have changed?',
        'Nehemiah answered a pull toward a bad meeting with one protective sentence (Nehemiah 6:3). Where do you need his sentence this month?',
      ],
    },
  },
  {
    id: 'll16-rule-your-spirit-repair-the-bond',
    title: 'Rule Your Spirit, Repair the Bond (difficult conversations, The Way)',
    // Harvested 2026-07-10: trial lawyer Jefferson Fisher (The Diary Of A CEO)
    // on difficult conversations and relationship repair — presence as the
    // highest authenticity, never reacting to the reaction, handling
    // manipulators unbothered, stopping the overexplain, sitting with sadness,
    // the power of small moments, the caged dynamic, the conflict/repair
    // cycle, energy checking ("what's in the tank"), nice vs kind, slicing
    // issues. Each move paired with the Scripture that commanded it first.
    anchor: { ref: 'Proverbs 16:32; Ephesians 4:26; 1 Peter 2:23', theme: 'He that ruleth his spirit is better than he that taketh a city; be angry and sin not — let not the sun go down upon your wrath; and when He was reviled, He reviled not again. The whole difficult conversation, governed in three verses: rule your own state, repair before sundown, and never hand a manipulator the reaction he came for.' },
    bigIdea: 'A trial lawyer who argues for a living teaches that the person who stays calm holds the room — and every one of his courtroom-tested moves is already a command in the Word. RULE YOUR OWN STATE: never react to the reaction; when the other person brings heat, matching it loses the root need. "He that is slow to anger is better than the mighty; and he that ruleth his spirit than he that taketh a city" (Proverbs 16:32). Facing a manipulator or a gaslighter, composure is not weakness — it is the Lord\u2019s own posture: "when he was reviled, reviled not again... but committed himself to him that judgeth righteously" (1 Peter 2:23) — you do not need to win the exchange; the righteous Judge holds the record. STOP OVEREXPLAINING: the waterfall of words surrenders authority and breeds sin besides — "In the multitude of words there wanteth not sin: but he that refraineth his lips is wise" (Proverbs 10:19); "let your communication be, Yea, yea; Nay, nay" (Matthew 5:37); "let thy words be few" (Ecclesiastes 5:2). BE PRESENT: presence is the highest authenticity — the Lord, thronged by a crowd, stopped for ONE touch: "Who touched my clothes?" (Mark 5:30-31); put the phone down and "let thine eyes look right on" (Proverbs 4:25). HONOR THE SMALL MOMENTS: He "calleth his own sheep by name" (John 10:3); the cup of water is remembered (Mark 9:41); what you do to the least — the support staff, the overlooked — you do to Him (Matthew 25:40). SIT WITH SADNESS: "weep with them that weep" (Romans 12:15); Job\u2019s friends were at their best the seven days they sat silent (Job 2:13) — empathy before answers. And in MARRIAGE AND FAMILY: the caged feeling dissolves when each esteems the other better than themselves and looks on the things of the other (Philippians 2:3-4) — prioritizing your partner\u2019s comfort builds safety, not lost freedom; a relationship dies not by one failure but by hundreds of missed REPAIRS, so repair fast — "let not the sun go down upon your wrath" (Ephesians 4:26), and reconciliation outranks even worship in the queue (Matthew 5:23-24); the 50/50 myth dies at Galatians 6:2 — "Bear ye one another\u2019s burdens" means when your partner has 20% in the tank, love carries the 80; and choose KIND over NICE — nice avoids the truth to stay comfortable, kind loves enough to say it: "Faithful are the wounds of a friend" (Proverbs 27:6), "speaking the truth in love" (Ephesians 4:15). Even his authenticity point — that shared weakness builds more trust than performed perfection — is Paul\u2019s doctrine: "My grace is sufficient for thee: for my strength is made perfect in weakness" (2 Corinthians 12:9).',
    inApp: 'Pick your ONE move for this week and run it in a real conversation: (1) rule your state — when someone brings heat, breathe and answer the need, not the emotion (Proverbs 16:32); (2) cut the waterfall — say it in one sentence and stop (Proverbs 10:19); (3) repair before sundown — one text, one knock, one "I want us right more than I want to be right" (Ephesians 4:26); or (4) run an energy check at home — "how much is in your tank today?" — and carry the difference (Galatians 6:2).',
    benefits: [
      'The ruled spirit — you stop handing manipulators the reaction they came for (Proverbs 16:32; 1 Peter 2:23).',
      'Authority through fewer words — the overexplain surrendered nothing but your peace (Proverbs 10:19; Matthew 5:37).',
      'Repair speed as the real metric — hundreds of small reconciliations beat one grand apology (Ephesians 4:26; Matthew 5:23-24).',
      'The tank check — 50/50 replaced by bear-one-another\u2019s-burdens honesty (Galatians 6:2).',
      'Kind over nice — truth in love instead of politeness hiding resentment (Proverbs 27:6; Ephesians 4:15).',
      'Presence as ministry — names remembered, small moments honored, the least esteemed (John 10:3; Matthew 25:40).',
    ],
    levels: {
      child: 'A man whose whole job is arguing in court says the person who stays CALM is the strongest one in the room — and the Bible said that first! "He that ruleth his spirit is better than he that taketh a city" (Proverbs 16:32). That means controlling your own temper is a bigger win than any battle. So when someone is mean or tries to make you mad, you do not have to get mad back — Jesus did not (1 Peter 2:23). Here are the moves: use FEW words instead of a waterfall of them (the Bible says lots of words lead to trouble, Proverbs 10:19); really LOOK at people when they talk — put the game down; remember people\u2019s NAMES like Jesus, the Good Shepherd, who calls His sheep by name (John 10:3); and if you have a fight with your brother or sister or friend, make it right FAST — the Bible says do not even let the sun go down while you are still angry (Ephesians 4:26). And when someone is sad, you do not need clever words — just sit with them and be sad with them (Romans 12:15). That is what a strong, kind heart looks like.',
      senior: 'For the seasoned believer, the trial lawyer\u2019s craft reads like a commentary on Proverbs. His first law — never react to the reaction — is the ruled spirit of Proverbs 16:32, and his manipulator counsel (stay unbothered; do not try to win) is precisely the Lord\u2019s posture under revilement: "committed himself to him that judgeth righteously" (1 Peter 2:23) — composure grounded not in technique but in a settled appeal to the higher court. His overexplaining warning is Proverbs 10:19 and Ecclesiastes 5:2 — the elder\u2019s few, weighed words carry what a younger man\u2019s waterfall cannot. His presence doctrine — that being fully there is the highest authenticity — is the Lord in the thronging crowd stopping for one touch (Mark 5:30-31), and his small-moments finding (names, gratitude to the unseen) is John 10:3 and Matthew 25:40 lived out. The marriage material deserves the most careful handling: the "caged" dynamic dissolves under Philippians 2:3-4 — mutual esteeming is the only frame where neither yields freedom by serving; the repair cycle IS Ephesians 4:26 and Matthew 5:23-24 — the marriages that last are not the ones that never tear but the ones that mend before sundown, hundreds of times; the 50/50 myth falls to Galatians 6:2 — covenant love carries 80 when the other has 20, without keeping books; and the nice/kind distinction is Proverbs 27:6 — the faithful wound versus the deceitful kiss, truth in love (Ephesians 4:15) versus politeness that banks resentment. His authenticity conclusion — weakness shared builds trust that performed perfection cannot — is 2 Corinthians 12:9 exactly. Teach these to the couples and the young men especially: the culture calls the ruled spirit passivity; the Word calls it mightier than city-taking.',
    },
    quiz: {
      questions: [
        { q: 'Someone brings heat, criticism, or manipulation at you. What is the first move?', options: ['Match their energy so they respect you', 'Rule your own spirit — answer the need, not the emotion (Proverbs 16:32), the way Jesus under revilement reviled not again (1 Peter 2:23)', 'Explain yourself thoroughly from the beginning'], answer: 1, explain: 'Never react to the reaction. Composure is not weakness; it is committed to the righteous Judge — and it keeps the root need addressable.' },
        { q: 'What does the research say relationships actually die from — and what does the Word prescribe?', options: ['One big failure; avoid all conflict', 'Hundreds of missed REPAIRS; so mend fast — "let not the sun go down upon your wrath" (Ephesians 4:26), reconcile before the altar (Matthew 5:23-24)', 'Not enough shared hobbies'], answer: 1, explain: 'Repair speed is the metric. The Word set the deadline at sundown and put reconciliation ahead of the offering.' },
        { q: 'Your spouse says "I only have 20% in the tank today." What does Galatians 6:2 make of the 50/50 rule?', options: ['They owe you the other 30%', 'The 50/50 myth dies — "Bear ye one another\u2019s burdens": love carries the 80 today, without keeping books', 'Postpone all conversation'], answer: 1, explain: 'Covenant love is not a ledger. The tank check is radical honesty; bearing the difference is the law of Christ.' },
        { q: 'What is the difference between NICE and KIND?', options: ['No difference', 'Nice avoids truth to stay comfortable (and banks resentment); kind loves enough to speak it — "faithful are the wounds of a friend" (Proverbs 27:6), "speaking the truth in love" (Ephesians 4:15)', 'Kind is quieter'], answer: 1, explain: 'Niceness protects the speaker; kindness serves the hearer. The Word sides with the faithful wound over the deceitful kiss.' },
      ],
    },
    lesson: 'It should not surprise the Body that a trial lawyer\u2019s hardest-won courtroom lessons turn out to be the Proverbs with a modern accent — but walk it slowly, because these are the conversations that decide households. START WITH THE RULED SPIRIT. His first law: never react to the reaction. When the other person arrives loud, wounded, or baiting, whatever you do next decides whether the ROOT need ever gets addressed — and matching their energy forfeits it. The Word weighed that skill against armies: "He that is slow to anger is better than the mighty; and he that ruleth his spirit than he that taketh a city" (Proverbs 16:32). And for the manipulator, the gaslighter, the one who argues in bad faith: his counsel is to stay unbothered and stop trying to win — which is not modern therapy-speak but the oldest picture in the faith: "Who, when he was reviled, reviled not again; when he suffered, he threatened not; but committed himself to him that judgeth righteously" (1 Peter 2:23). You can afford composure because the record is kept in a higher court. THEN CLOSE THE WATERFALL. Overexplaining feels like defense and works like surrender — every extra sentence hands the room your authority. "In the multitude of words there wanteth not sin: but he that refraineth his lips is wise" (Proverbs 10:19); "let your communication be, Yea, yea; Nay, nay" (Matthew 5:37); "let thy words be few" (Ecclesiastes 5:2). Say it once, plainly, and let it stand. BE THERE. He calls presence the highest form of authenticity — the phone face-down is a message of honor before a word is spoken. The Lord modeled presence in a crush of people: "Who touched my clothes?" (Mark 5:30-31) — thronged by a multitude, He stopped for one. And the small moments he says land hardest — remembering a name, thanking the person everyone overlooks — are the Shepherd\u2019s signature: He "calleth his own sheep by name" (John 10:3); the cup of water does not lose its reward (Mark 9:41); "Inasmuch as ye have done it unto one of the least of these... ye have done it unto me" (Matthew 25:40). WHEN SADNESS COMES, SIT DOWN. Empathy is a skill most never build: stop fixing, start weeping-with — "weep with them that weep" (Romans 12:15). Job\u2019s three friends were never wiser than the seven days they sat on the ground and "none spake a word" (Job 2:13); their trouble began when they opened their mouths. NOW THE HOUSE ITSELF. The "caged" feeling — one partner guarding scraps of freedom, treating every concession as loss — is a zero-sum lie, and the Word\u2019s cure is total: "in lowliness of mind let each esteem other better than themselves. Look not every man on his own things, but every man also on the things of others" (Philippians 2:3-4). Two people racing to honor each other cannot build a cage; under the surface behavior (the phone in the bedroom, the tone at dinner) there is always a NEED — connection, safety, being heard — and the need, not the behavior, is the conversation. THE REPAIR CYCLE: relationships do not fall to one failure; they bleed out through hundreds of missed repairs. The metric that matters is how fast you return to connection — and the Word set the deadline: "Be ye angry, and sin not: let not the sun go down upon your wrath" (Ephesians 4:26). Kingdom priority is even sharper: leave the gift AT THE ALTAR and go be reconciled first (Matthew 5:23-24) — repair outranks religion. Validate before you volley: their feeling gets received before your frustration gets introduced; validation is not surrender, it is the mechanism of repair. THE TANK: the 50/50 marriage is a myth with a ledger where a covenant should be. Radical honesty — "I have 20% today" — invites the covenant answer: "Bear ye one another\u2019s burdens, and so fulfil the law of Christ" (Galatians 6:2). Love carries the 80 without invoicing it. KIND, NOT NICE: nice is surface politeness that avoids truth and quietly banks resentment; kind cares enough to say the hard thing tenderly — "Faithful are the wounds of a friend; but the kisses of an enemy are deceitful" (Proverbs 27:6); "speaking the truth in love" (Ephesians 4:15). SLICE THE ISSUES: do not let ten old grievances arrive wearing tonight\u2019s argument\u2019s coat; take the one matter at hand, with curiosity instead of a verdict to win. And BRING YOUR REAL SELF: performed perfection builds distance; confessed weakness builds trust — "My grace is sufficient for thee: for my strength is made perfect in weakness" (2 Corinthians 12:9). The lawyer learned in courtrooms what the Body was told from the beginning: the ruled spirit wins the room, the fast repair keeps the house, and the kind truth — spoken few, spoken present, spoken in love — is The Way.',
    facilitator: {
      talkingPoints: [
        'Never react to the reaction — the ruled spirit outranks the city-taker (Proverbs 16:32); manipulators get composure, not a win (1 Peter 2:23).',
        'The overexplain surrenders authority — few words, weighed (Proverbs 10:19; Matthew 5:37; Ecclesiastes 5:2).',
        'Presence is the highest authenticity — the Lord stopped a crowd for one touch (Mark 5:30-31); names and small moments are the Shepherd\u2019s signature (John 10:3; Matthew 25:40).',
        'Sadness wants presence, not solutions — weep with them (Romans 12:15); Job\u2019s friends were wisest silent (Job 2:13).',
        'The caged dynamic dies under mutual esteeming (Philippians 2:3-4) — the NEED under the behavior is the real conversation.',
        'Repair speed is the metric — before sundown (Ephesians 4:26), before the altar (Matthew 5:23-24); validate before you volley.',
        'The tank check kills the 50/50 ledger — bear one another\u2019s burdens (Galatians 6:2).',
        'Kind over nice — the faithful wound versus the deceitful kiss (Proverbs 27:6; Ephesians 4:15). Slice issues; bring real weakness (2 Corinthians 12:9).',
      ],
      howToRun: 'Open in prayer + read the Scripture (3): read Proverbs 16:32 and Ephesians 4:26 aloud. | The big idea (10): the lawyer\u2019s laws are the Proverbs — walk the ruled spirit, the waterfall, presence. | Go deeper (10): the house — caged vs esteeming, the repair cycle, the tank, kind vs nice; practice ONE validation exchange in pairs. | Reflect together (10): use the prompts; make room for anyone in a hard season at home. | Take it with you (2): each person names their one move for the week out loud.',
      discussionPrompts: [
        'Where do you most reliably "react to the reaction" — and what would ruling your spirit (Proverbs 16:32) look like in that exact moment?',
        'Whose revilement are you still trying to answer? What does 1 Peter 2:23 — committing it to the righteous Judge — release you from?',
        'Where does your overexplaining live (work, marriage, church)? What is the one-sentence version of the thing you keep saying in ten?',
        'What repair have you left past sundown (Ephesians 4:26)? What would mending it THIS week look like?',
        'Ask your spouse or a family member the tank question this week — "how much is in there today?" — and carry the difference (Galatians 6:2). What changed?',
        'Where have you been nice when kindness required the faithful wound (Proverbs 27:6)?',
      ],
    },
  },
  {
    id: 'll17-taste-and-see',
    title: 'Taste and See (the empirical invitation)',
    // Captured from Darrell's question spoken into the app, 2026-07-10: "What
    // does the Scripture mean when it says Taste and See that the Lord IS
    // Good — how do you taste and see in a practical sense?" Answered from the
    // Word's own usage: taste = the firsthand trial; see = the trial's
    // observed result; Psalm 34 itself is David's published record of one.
    anchor: { ref: 'Psalm 34:8; John 7:17; 1 Peter 2:2-3', theme: 'O taste and see that the LORD is good: blessed is the man that trusteth in him. Tasting is the firsthand trial no one can run for you; seeing is the trial\u2019s result; and whoever DOES His will shall KNOW the doctrine. One real taste creates the appetite for the sincere milk of the Word.' },
    bigIdea: '"O taste and see that the LORD is good: blessed is the man that trusteth in him" (Psalm 34:8) is not poetry about feelings — it is Yahweh\u2019s empirical invitation, one of the plainest algorithms in the Book: RUN THE TRIAL YOURSELF, then read the result. TASTE is the one kind of knowledge that cannot be borrowed: you can watch a thousand people eat and still not know the flavor; you can hear a thousand testimonies and still not know the LORD. The verb demands firsthand contact — trust Him with a real matter, act on a real promise, obey a real command, take refuge in a real trouble. SEE is the trial\u2019s returned result: knowledge by experience, not by argument. And the Word tells you exactly where the laboratory is. Psalm 34 itself is David\u2019s published lab report — written out of a real crisis (fleeing Saul, feigning madness before the Philistine king): "I sought the LORD, and he heard me, and delivered me from all my fears" (Psalm 34:4); "This poor man cried, and the LORD heard him, and saved him out of all his troubles" (Psalm 34:6). Verse 8 is not theory; it is David handing you his data and saying: now run it yourself. Jesus states the same protocol for doctrine: "If any man will do his will, he shall know of the doctrine, whether it be of God" (John 7:17) — DOING is the knowing; the experiment precedes the certainty. Yahweh even names one trial He explicitly invites: "prove me now herewith, saith the LORD of hosts, if I will not open you the windows of heaven" (Malachi 3:10) — the tithe is the one place in Scripture where God says TEST ME. The Word itself is tastable food: "Thy words were found, and I did eat them; and thy word was unto me the joy and rejoicing of mine heart" (Jeremiah 15:16); "How sweet are thy words unto my taste! yea, sweeter than honey to my mouth!" (Psalm 119:103) — eaten, not sampled; ingested until it becomes you. And tasting compounds: "If so be ye have tasted that the Lord is gracious," Peter says, you will "desire the sincere milk of the word, that ye may grow thereby" (1 Peter 2:2-3) — one real taste creates the appetite. The Bread of Life stands at the end of every trail: "he that cometh to me shall never hunger" (John 6:35).',
    inApp: 'Run ONE trial this week — pick it now: (1) act on one promise of the Word in a real decision and write down what happens; (2) eat the Word daily — same time, same place, until a verse is IN you, not just past you (Jeremiah 15:16); (3) bring a real trouble to Him FIRST, before you call anyone, and record what He does (Psalm 34:4,6 is exactly that record); or (4) run the one test He Himself invited (Malachi 3:10). Then WRITE the result where you will find it again — a taste recorded becomes goodness seen forever ("forget not all his benefits," Psalm 103:2).',
    benefits: [
      'Firsthand faith — a record of YOUR OWN tasted-and-seen trials that no argument can take from you.',
      'The right laboratory — real decisions, real troubles, real promises; not theory run in your head.',
      'The Word as food — eaten daily until it is joy (Jeremiah 15:16), not sampled until it is familiar.',
      'The knowing that follows doing (John 7:17) — obedience as the experiment that settles doctrine.',
      'Compounding appetite — one true taste makes you hungry for the milk of the Word (1 Peter 2:2-3).',
      'A kept record — watching, recognizing, and recording His goodness turns tastes into permanent sight.',
    ],
    levels: {
      child: 'Imagine someone tells you a peach is delicious. You can hear about peaches all day long — but there is only ONE way to really know: take a bite yourself! The Bible says the same thing about God: "O taste and see that the LORD is good" (Psalm 34:8). That means: try Him yourself! Here is how a kid can taste and see: when you are scared or have a problem, pray to God FIRST and watch what He does — David did exactly that, and he wrote, "I sought the LORD, and he heard me" (Psalm 34:4). Read a little bit of the Bible every day like it is food for your heart. Obey what God says — like being kind or telling the truth — and watch what happens. And here is the special part: write down or remember what God does for you! Every time you see Him answer, that is one more bite — and the more you taste, the more you will KNOW, all by yourself, that God is good.',
      senior: 'For the seasoned believer, Psalm 34:8 rewards its context. David wrote it out of the Gath episode — a fugitive feigning madness before Abimelech, delivered not by his performance but by the LORD he sought — and the psalm is structured as a published trial: the report ("I sought the LORD, and he heard me," v.4; "This poor man cried," v.6), then the invitation to replicate ("O taste and see," v.8). Taste (Hebrew ta\u2019am — to perceive by direct experience, the same root as discernment) is intrinsically first-person: the one epistemology that cannot be delegated, inherited, or argued into a soul. Seeing is the posterior knowledge the trial returns, and the verse carries its own consequence-clause: "blessed is the man that trusteth in him." The New Testament keeps the protocol intact: doctrine is known by DOING the will (John 7:17); the Lord\u2019s graciousness, once tasted, produces appetite for the Word\u2019s milk (1 Peter 2:2-3); the enlightened have "tasted the good word of God, and the powers of the world to come" (Hebrews 6:5). The seasoned danger is subtle: decades of orthodoxy can substitute the menu for the meal — knowing ABOUT His goodness from sermons and doctrine while the last personal trial fades from memory. The remedy is the discipline you can now teach: keep running trials (a promise acted on, a trouble brought to Him first, the tithe test He Himself invited, Malachi 3:10), and keep the RECORD — the testimony diary, the remembered deliverances — because a written taste becomes sight for the generation after you, exactly as David\u2019s psalm became sight for us. And guard the doctrine of the table: communion is the memorial where taste is literal, and the Bread of Life (John 6:35) is the goodness every lesser taste was pointing to.',
    },
    quiz: {
      questions: [
        { q: 'What kind of knowledge does "taste" demand in Psalm 34:8?', options: ['Secondhand — a trusted report is enough', 'Firsthand — a trial you run yourself; no one can taste by watching another eat', 'Academic — study until convinced'], answer: 1, explain: 'Tasting is the one epistemology that cannot be delegated. David published his own trial (Psalm 34:4,6) and invited yours (v.8).' },
        { q: 'Jesus gave the same protocol for knowing doctrine. What is it?', options: ['Debate it thoroughly', '"If any man will do his will, he shall know of the doctrine" (John 7:17) — DOING is the experiment that settles the knowing', 'Wait for certainty before obeying'], answer: 1, explain: 'The experiment precedes the certainty. Obedience is the trial; knowledge is its result.' },
        { q: 'Where is the ONE place God explicitly says "prove me"?', options: ['Nowhere — testing God is always forbidden', 'The tithe (Malachi 3:10) — "prove me now herewith... if I will not open you the windows of heaven"', 'Fasting'], answer: 1, explain: 'Presumptuous testing is forbidden; this invited trial is commanded. He names the experiment and stakes His own faithfulness on the result.' },
        { q: 'What turns a taste into lasting sight?', options: ['A strong memory', 'The RECORD — writing down what He did, so the trial becomes retrievable testimony ("forget not all his benefits," Psalm 103:2)', 'Repeating it to yourself'], answer: 1, explain: 'David\u2019s psalm IS a kept record that became sight for every generation after him. Watch, recognize, record.' },
      ],
    },
    lesson: 'The question was asked plainly, so let the Word answer plainly: what does "O taste and see that the LORD is good" (Psalm 34:8) actually mean, and how do you DO it? Start with what kind of sentence it is. It is not a description; it is an INVITATION TO AN EXPERIMENT — the most empirical sentence in the Psalter. Yahweh does not say "be told and agree that the LORD is good." He says taste — and taste is the one kind of knowledge nobody can hand you. You can watch a thousand people eat and never know the flavor. You can sit under fifty years of preaching, inherit your grandmother\u2019s faith, memorize the doctrine — and still only know ABOUT Him, the way a man knows about honey from a label. Taste demands contact. Now look at WHERE the verse sits, because the psalm is its own proof. David wrote Psalm 34 out of one of the worst corners of his life — a fugitive from Saul, alone in enemy territory, reduced to feigning madness before a Philistine king. And the psalm opens with a lab report, not a lecture: "I sought the LORD, and he heard me, and delivered me from all my fears" (Psalm 34:4). "This poor man cried, and the LORD heard him, and saved him out of all his troubles" (Psalm 34:6). THEN comes verse 8. David is doing what every honest scientist does: publishing his data and inviting replication — I ran the trial in a real crisis; here is what came back; now run it yourself. So the practical answer: TASTING IS RUNNING A REAL TRIAL, and the Word names four laboratories. FIRST, the trouble lab: next real trouble, go to Him FIRST — before the phone call, before the spiral — and then watch what He does. That is precisely the trial David ran. SECOND, the promise lab: take ONE promise of the Word and act on it in a real decision — build the choice on the promise and let the outcome come in. Jesus guaranteed this protocol for doctrine itself: "If any man will do his will, he shall know of the doctrine, whether it be of God" (John 7:17) — the doing IS the experiment; the knowing is its result. You will never know from the audience. THIRD, the invited test: there is exactly one place in all of Scripture where God says PROVE ME — "Bring ye all the tithes into the storehouse... and prove me now herewith, saith the LORD of hosts, if I will not open you the windows of heaven" (Malachi 3:10). He names the experiment and stakes His faithfulness on the result. Most believers quote the promise and never run the trial. FOURTH, the table lab: the Word itself is food. "Thy words were found, and I did EAT them; and thy word was unto me the joy and rejoicing of mine heart" (Jeremiah 15:16). "How sweet are thy words unto my taste! yea, sweeter than honey to my mouth!" (Psalm 119:103). Eating is not sampling — it is daily, it is ingested, it becomes you. Read until a verse is IN you and watch what it does to your days; that too is tasting. AND THEN — SEE. Seeing is the trial\u2019s returned result, and it needs one discipline to become permanent: THE RECORD. Watch what He does, recognize it as Him, and WRITE IT DOWN — because an unrecorded taste fades into coincidence, but a recorded one becomes sight forever, and even sight for your children, exactly as David\u2019s written record became sight for us three thousand years later. "Bless the LORD, O my soul, and forget not all his benefits" (Psalm 103:2). Peter adds the beautiful mechanics: tasting compounds — "If so be ye have tasted that the Lord is gracious," you will "desire the sincere milk of the word, that ye may grow thereby" (1 Peter 2:2-3). One real answered trial makes you hungry for the next; appetite is the evidence of a real first bite. And every taste points to the Table it came from: "I am the bread of life: he that cometh to me shall never hunger" (John 6:35). So: pick your trial this week. Go first to Him in the trouble, act on the promise, run the invited test, eat the Word daily — and keep the record. The goodness of the LORD is not a claim you are asked to swallow. It is a table you are invited to sit down at. Taste — and you will see.',
    facilitator: {
      talkingPoints: [
        'Psalm 34:8 is an invitation to an EXPERIMENT — taste is firsthand trial; see is the trial\u2019s result; no one can taste for you.',
        'The psalm is David\u2019s own lab report from the Gath crisis: the data (34:4,6) precedes the invitation (34:8).',
        'The four laboratories: the trouble lab (go to Him FIRST), the promise lab (act on one promise), the invited test (Malachi 3:10 — the one "prove me" in Scripture), the table lab (eat the Word daily, Jeremiah 15:16).',
        'Jesus\u2019 protocol: doing His will is how doctrine is KNOWN (John 7:17) — the experiment precedes the certainty.',
        'The record turns taste into permanent sight: watch, recognize, WRITE IT DOWN (Psalm 103:2) — David\u2019s record became our sight.',
        'Tasting compounds: one real taste creates appetite for the milk of the Word (1 Peter 2:2-3); all tastes point to the Bread of Life (John 6:35).',
      ],
      howToRun: 'Open in prayer + read the Scripture (3): read Psalm 34:4-8 aloud — notice the report BEFORE the invitation. | The big idea (10): taste = firsthand trial; see = the result; the menu is not the meal. | Go deeper (10): walk the four laboratories; let anyone share a trial they have actually run and what came back. | Reflect together (10): use the prompts; make room for the one who has only ever known ABOUT Him. | Take it with you (2): every person picks ONE trial for this week and says it out loud — and agrees to write down the result.',
      discussionPrompts: [
        'Where has your faith been living on the menu instead of the meal — knowing ABOUT His goodness from reports rather than from your own trials?',
        'David went to the LORD first in the Gath crisis (Psalm 34:4). In your last real trouble, who or what did you go to first — and what would the trial look like next time?',
        'Which of the four laboratories will you run this week: the trouble lab, the promise lab, the invited test (Malachi 3:10), or the table lab (daily eating)?',
        'John 7:17 says doing His will is how you come to KNOW. What obedience have you postponed while waiting to feel certain first?',
        'What answered prayer or deliverance have you never written down? What would recording it — for your children to read — turn it into?',
        'Peter says one real taste creates appetite (1 Peter 2:2-3). Is your appetite for the Word growing or fading — and what does that tell you about your last real taste?',
      ],
    },
  },
  {
    id: 'll18-the-flinch-comes-first',
    title: 'The Flinch Comes First (body first, recognition second, choice third)',
    // Captured from a teaching Darrell spoke into the app, 2026-07-11 -- Dr.
    // Tracey Marks (psychiatrist, mental-health educator) on fast-vs-slow
    // processing: the body's alarm ("the flinch") fires before meaning
    // arrives; separate the flinch from the meaning; pause and reset on
    // "what do I actually know right now?"; create space with "let me think
    // about that." Body first, recognition second, choice third -- which is
    // the neuroscience underneath the Mind of Christ discipline the platform
    // already teaches: NOTICE -> TEST -> CAPTURE -> REDIRECT. Enriched same
    // day from the fuller timestamped summary: survival-over-accuracy tuning,
    // the snake example, "they are mad at me", and "I need a minute" as the
    // second space sentence \u2014 a timing issue, not a personal flaw.
    anchor: { ref: 'Ephesians 4:26; James 1:19; 2 Corinthians 10:5', theme: 'Be ye angry, and sin not \u2014 the feeling arrives before the sin question even begins. Swift to hear, slow to speak, slow to wrath \u2014 the sequence is the design. Casting down imaginations... bringing into captivity every thought \u2014 the flinch is noticed, the story it writes is tested, and the choice is made in Christ.' },
    bigIdea: 'Your body reacts before your mind understands \u2014 and that is DESIGN, not sin. The brain runs two speeds: a fast, rough alarm system built for immediate safety and a slower, detailed system that carries context and logic \u2014 and the alarm is tuned to prioritize survival over accuracy, so a sharp word or a hard text reaches your heart rate before it reaches your understanding. You flinch first; the story arrives second. That is a TIMING issue, not a personal flaw. The Word wrote the order down first: "Be ye angry, and sin not: let not the sun go down upon your wrath" (Ephesians 4:26) \u2014 Scripture assumes the feeling ARRIVES and locates obedience in what happens NEXT, not in never feeling. The danger is not the flinch; it is the instant story the flinch writes \u2014 and that story is a party in its own cause: "He that is first in his own cause seemeth just; but his neighbour cometh and searcheth him" (Proverbs 18:17). So the discipline runs in three beats. BODY FIRST: notice the alarm as a body event \u2014 name it, without shame. RECOGNITION SECOND: search the story before obeying it \u2014 the reset question is "what do I actually know right now?", which is Philippians 4:8 opening its first gate ("whatsoever things are TRUE... think on these things") and 2 Corinthians 10:5 in motion ("casting down imaginations... bringing into captivity every thought to the obedience of Christ"). CHOICE THIRD: "What time I am afraid, I will trust in thee" (Psalm 56:3) \u2014 fear arrives without permission; trust is chosen. Elijah lived the whole sequence in one chapter (1 Kings 19): the body fled first, the false story came second under the juniper tree, and Yahweh \u2014 who built the design \u2014 ministered to it body-first: food and sleep, twice, before one word of correction. This is the platform\u2019s own Mind of Christ discipline \u2014 NOTICE, TEST, CAPTURE, REDIRECT \u2014 with the neuroscience underneath it now visible: the science and the Word agree.',
    inApp: 'Run the three beats on ONE real trigger this week. When the flinch hits: (1) BODY \u2014 name it out loud or in your head: "that is my alarm, not yet the truth"; (2) RECOGNITION \u2014 ask the reset question, "What do I actually know right now?", and keep only what passes TRUE (Philippians 4:8); (3) CHOICE \u2014 buy the space with one sentence \u2014 "Let me think about that" or "I need a minute" ("a wise man keepeth it in till afterwards," Proverbs 29:11), then choose your response on what you know, not on the story the alarm wrote. The Mind of Christ course in this app teaches the same sequence as NOTICE \u2192 TEST \u2192 CAPTURE \u2192 REDIRECT \u2014 run them together and the habit doubles.',
    benefits: [
      'The condemnation lifts \u2014 the flinch is design, not sin (Ephesians 4:26); obedience lives in the next beat, not in never feeling.',
      'A searched story \u2014 the first version always "seemeth just" (Proverbs 18:17); you stop obeying an unexamined narrator.',
      'The reset question \u2014 "what do I actually know right now?" makes Philippians 4:8\u2019s first gate (TRUE) a reflex.',
      'Bought space \u2014 "let me think about that" is Proverbs 29:11 in one sentence; the answer that waits is wiser.',
      'Fear rightly ordered \u2014 fear arrives first and trust is CHOSEN third (Psalm 56:3); the sound mind is given, not mustered (2 Timothy 1:7).',
      'One shared sequence \u2014 body first, recognition second, choice third IS NOTICE \u2192 TEST \u2192 CAPTURE \u2192 REDIRECT; the science under the discipline you already have.',
    ],
    levels: {
      child: 'When something scary or upsetting happens, your body jumps FIRST \u2014 your heart beats fast, your tummy squeezes \u2014 before you even know what happened! God built you that way to keep you safe \u2014 it is the same part of you that would jump away from something that LOOKS like a snake before you even think about it! So the jumpy feeling is not bad and it is not the truth yet. It is just your body\u2019s alarm bell. The Bible says to be "swift to hear, slow to speak" (James 1:19) \u2014 that means: listen and find out what really happened BEFORE you react. Even a great hero like Elijah got so scared that he ran far, far away (1 Kings 19:3). And do you know what God did? He did not scold him! He sent an angel with warm food and let Elijah take a long nap \u2014 twice! \u2014 and only talked with him about it afterward. So next time your body jumps, try the three steps: (1) say "that is just my alarm"; (2) ask "what do I REALLY know?"; (3) say "let me think about that." Then you get to choose what to do! King David knew the secret: "What time I am afraid, I will trust in thee" (Psalm 56:3). The scared comes first all by itself \u2014 but trusting God is what YOU get to choose next.',
      senior: 'For the seasoned believer, this lesson dignifies what you have lived: decades of walking with the Lord do not remove the flinch \u2014 Elijah\u2019s came AFTER Carmel, at the very peak of his ministry. "He arose, and went for his life" (1 Kings 19:3): the body fled first. The story arrived second, under the juniper tree: "It is enough; now, O LORD, take away my life; for I am not better than my fathers" (1 Kings 19:4) \u2014 and the story was false; seven thousand had not bowed. Watch how Yahweh treated the flinch: not one word of rebuke first. An angel, a touch, "Arise and eat," a cake baken on the coals, a cruse of water, sleep \u2014 and food a second time, "because the journey is too great for thee" (1 Kings 19:7). Heaven\u2019s own pastoral care was body-first; only afterward, at Horeb, did the question and the still small voice reorder the story. The senior temptation is to spiritualize the flinch into a verdict \u2014 reading the body\u2019s alarm as God\u2019s voice, or as proof of personal failure. It is neither: it is the watchman\u2019s bell, not the King\u2019s word. Your years give you an advantage the young do not have \u2014 a longer record of "what I actually know": decades of kept benefits ("forget not all his benefits," Psalm 103:2) to test tonight\u2019s story against. And you can now teach the ordered sequence to the generation behind you: the feeling is first and carries no guilt (Ephesians 4:26); the meaning is second and must be searched (Proverbs 18:17); the choice is third and is yours in Christ \u2014 "For God hath not given us the spirit of fear; but of power, and of love, and of a sound mind" (2 Timothy 1:7).',
    },
    quiz: {
      questions: [
        { q: 'When the alarm feeling hits your body before you know why, what is it?', options: ['Sin \u2014 a mature believer would not feel it', 'Design \u2014 the body\u2019s fast alarm fires before meaning arrives; "Be ye angry, and sin not" (Ephesians 4:26) locates obedience AFTER the feeling', 'God\u2019s verdict on the situation'], answer: 1, explain: 'The Word assumes the feeling arrives first. The command governs what happens next \u2014 not the arrival.' },
        { q: 'The flinch instantly writes a story ("they meant that," "it is ruined"). How does the Word treat that first story?', options: ['Trust it \u2014 first instincts are truth', 'Search it \u2014 "He that is first in his own cause seemeth just; but his neighbour cometh and searcheth him" (Proverbs 18:17); ask "what do I actually know right now?"', 'Suppress it and feel nothing'], answer: 1, explain: 'The first story is a party in its own cause. Philippians 4:8 opens at TRUE \u2014 the story must pass that gate before it earns your obedience.' },
        { q: 'What did Yahweh give Elijah FIRST when the prophet fled and asked to die?', options: ['A rebuke for weak faith', 'Food, water, and sleep \u2014 twice \u2014 "because the journey is too great for thee" (1 Kings 19:7); the story was corrected only afterward, at Horeb', 'A new assignment immediately'], answer: 1, explain: 'Heaven\u2019s own care was body-first, recognition second. The Designer honors the design He built.' },
        { q: 'Where does choice come in the sequence?', options: ['First \u2014 choose never to feel', 'Third \u2014 body first, recognition second, choice third: "What time I am afraid, I will trust in thee" (Psalm 56:3)', 'Nowhere \u2014 feelings decide'], answer: 1, explain: 'Fear arrives without permission; trust is chosen. That chosen third beat is the sound mind God has given (2 Timothy 1:7).' },
      ],
    },
    lesson: 'This lesson was spoken into the app from a teaching by Dr. Tracey Marks, a psychiatrist who has spent her career helping people understand their own minds \u2014 and her core observation is one the Word wrote down first. The brain runs at two speeds: a fast, rough alarm system designed for immediate safety \u2014 the one that jumps you away from what might be a snake before you have decided anything \u2014 and a slower, detailed system responsible for context and logic. The alarm is built to prioritize survival over accuracy: being fast matters more to it than being right. So a sharp word, a certain tone, an unexpected message \u2014 the signal reaches your body\u2019s alarm system BEFORE it reaches your thinking brain. The heart rate jumps, the chest tightens, the face heats \u2014 and only afterward does a story arrive to explain it. Call that first beat THE FLINCH. The sequence is fixed by design: body first, recognition second, choice third. Now hear the Word, which had the order all along. "Be ye angry, and sin not: let not the sun go down upon your wrath" (Ephesians 4:26). Read it slowly: the verse ASSUMES the anger arrives \u2014 it does not say "be ye never angry." The feeling comes first, unbidden; the sin question begins at the next beat \u2014 what you do with it, and how long you house it. That one verse lifts a weight many believers have carried for years: the flinch itself is not the failure. God built the alarm; He is not surprised when it rings. THE REAL DANGER IS THE STORY. The flinch never arrives alone \u2014 it writes an instant narrative: "they are mad at me," "they meant to disrespect you," "it is all ruined," "you are in danger." And Scripture has that narrator\u2019s number: "He that is first in his own cause seemeth just; but his neighbour cometh and searcheth him" (Proverbs 18:17). The first story SEEMS just \u2014 it always does; it got there first and argued its case with your own adrenaline for a lawyer. Obeying it unsearched is exactly what the Word calls folly: "He that answereth a matter before he heareth it, it is folly and shame unto him" (Proverbs 18:13) \u2014 and that applies inward too: reacting to the flinch\u2019s story before the facts are heard is answering a matter before hearing it. SO SEPARATE THE FLINCH FROM THE MEANING. The feeling is real; the story is a draft. Dr. Marks\u2019 reset question is the searchlight: "What do I actually know right now?" Stand in the middle of the alarm and answer it honestly \u2014 not what you feel, not what you fear, what you KNOW. That question is Philippians 4:8 opening its first gate: "whatsoever things are TRUE... think on these things" \u2014 truth is the first filter, and the flinch\u2019s draft rarely passes it whole. And it is 2 Corinthians 10:5 in motion: "Casting down imaginations, and every high thing that exalteth itself against the knowledge of God, and bringing into captivity every thought to the obedience of Christ." The imagination to cast down is often precisely the story your alarm just wrote. THEN CREATE THE SPACE. "Wherefore, my beloved brethren, let every man be swift to hear, slow to speak, slow to wrath" (James 1:19) \u2014 notice that James\u2019 order matches the design: hearing first (gather what is actually known), speaking second (and slowly), wrath last of all. One sentence buys the space: "Let me think about that" \u2014 or simply "I need a minute." That is not weakness; it is Proverbs 29:11 in six words \u2014 "A fool uttereth all his mind: but a wise man keepeth it in till afterwards." The fool publishes the flinch; the wise man holds it until the search is done. AND THEN \u2014 CHOOSE. The third beat is the only one that was ever yours: "What time I am afraid, I will trust in thee" (Psalm 56:3). David does not pretend the fear away \u2014 "what time I am afraid" concedes it arrives, body-first, without permission. Trust is what he CHOOSES at the third beat. "He that is slow to anger is better than the mighty; and he that ruleth his spirit than he that taketh a city" (Proverbs 16:32) \u2014 rule of the spirit happens here, in the chosen beat, not in the unchosen first one. And the capacity is supplied: "For God hath not given us the spirit of fear; but of power, and of love, and of a sound mind" (2 Timothy 1:7). WATCH THE WHOLE SEQUENCE LIVE IN ELIJAH. Fresh off the fire of Carmel, one threat from Jezebel reached his alarm: "he arose, and went for his life" (1 Kings 19:3) \u2014 the body fled FIRST. The story arrived second, under the juniper tree: "It is enough; now, O LORD, take away my life; for I am not better than my fathers" (1 Kings 19:4) \u2014 a flinch-written draft, and false: seven thousand in Israel had not bowed. Now watch the Designer handle His design. No rebuke. An angel touched him: "Arise and eat" \u2014 "a cake baken on the coals, and a cruse of water at his head" (1 Kings 19:6) \u2014 then more sleep, then food AGAIN, "because the journey is too great for thee" (1 Kings 19:7). Yahweh ministered BODY-FIRST \u2014 food and rest before one word of correction \u2014 and only afterward, at Horeb, in a still small voice, did He search the story and reorder it. If heaven itself honors the sequence, so can you: be as patient with your own alarm \u2014 and with your children\u2019s, your spouse\u2019s, your brother\u2019s \u2014 as God was with Elijah\u2019s. FINALLY, KNOW THAT YOU ALREADY OWN THIS DISCIPLINE. This platform\u2019s Mind of Christ course teaches NOTICE \u2192 TEST \u2192 CAPTURE \u2192 REDIRECT: notice the thought, test it against Philippians 4:8, capture what fails (2 Corinthians 10:5), redirect to what is true. Body first, recognition second, choice third is the same sequence seen from underneath \u2014 the neuroscience of the design the Word has been describing all along. The alarm is the watchman\u2019s bell, not the King\u2019s word. Let it ring, thank God it works, search the story it wrote \u2014 and then, at the beat that is yours, choose trust.',
    facilitator: {
      talkingPoints: [
        'The flinch is design, not sin: the body\u2019s alarm fires before meaning arrives, and "Be ye angry, and sin not" (Ephesians 4:26) locates obedience AFTER the feeling, not at it.',
        'The flinch writes an instant story, and that story is "first in his own cause" (Proverbs 18:17) \u2014 it seems just until it is searched.',
        'The reset question \u2014 "what do I actually know right now?" \u2014 is Philippians 4:8\u2019s first gate (TRUE) made practical, and 2 Corinthians 10:5 in motion.',
        'One sentence buys the space: "Let me think about that" \u2014 Proverbs 29:11 in six words; James 1:19\u2019s order (hear, speak, wrath) matches the design.',
        'Elijah lived the whole sequence (1 Kings 19:3-8): the body fled first, the false story came second, and Yahweh ministered body-first \u2014 food and sleep, twice, before the still small voice corrected the story.',
        'The platform already teaches this as the Mind of Christ discipline \u2014 NOTICE \u2192 TEST \u2192 CAPTURE \u2192 REDIRECT; body/recognition/choice is the neuroscience underneath it.',
      ],
      howToRun: 'Open in prayer + read the Scripture (3): read Ephesians 4:26 and James 1:19 aloud \u2014 notice the ORDER built into both. | The big idea (10): body first, recognition second, choice third \u2014 the flinch is the alarm, not the verdict, and the first story must be searched. | Go deeper (10): walk Elijah\u2019s flinch (1 Kings 19:3-8) \u2014 the flight, the false story under the juniper tree, and heaven\u2019s body-first care; then practice the reset question and the space sentence together. | Reflect together (10): use the prompts; let people name their own flinch patterns without shame \u2014 the room should feel like the angel\u2019s meal, not a courtroom. | Take it with you (2): every person picks ONE trigger to run the three beats on this week \u2014 and says "Let me think about that" out loud once before leaving.',
      discussionPrompts: [
        'What does your flinch feel like in your body \u2014 and how fast does a story arrive to explain it?',
        '"Be ye angry, and sin not" (Ephesians 4:26): where have you treated the FEELING itself as the failure \u2014 and what changes if obedience lives in the next beat instead?',
        'Recall a time the first story "seemed just" (Proverbs 18:17) and turned out wrong once searched. What did the search reveal?',
        'What would asking "what do I actually know right now?" have changed in your last hard conversation?',
        'Yahweh gave Elijah food and sleep \u2014 twice \u2014 before He corrected the story (1 Kings 19:5-8). What does that teach about how to treat yourself, and others, mid-flinch?',
        '"What time I am afraid, I will trust in thee" (Psalm 56:3): fear comes first, trust is chosen third. What fear is waiting for you to choose the third beat this week?',
      ],
    },
  }
];
