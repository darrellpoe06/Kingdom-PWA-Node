...
describe('proven-to-catch — the ratchet flags growth, never blocks shrink', () => {
  it('FAILS when the monolith grows past the frozen budget', () => {
    const v = evaluate(9573, 9572); // one line over
