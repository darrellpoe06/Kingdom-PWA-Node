...
function allQuotedPairs() {
  ...
  for (const list of [gh.theTrajectoryNamed, gh.theAbigailDoctrine, gh.whatTheSpouseDoes, gh.whatTheSpouseSays, gh.theHonestLimits, gh.theTimelines, gh.assumingTheStewardship, gh.halfTheIncome, gh.theProvenUnfaithfulServant, gh.thenWhat]) {
    for (const v of list) pairs.push({ ref: v.ref, fragment: v.fragment });
  }
