...
describe('the category is decided at birth, with its basis', () => {
  ...
  it('PROVEN TO CATCH: a database without 0236 still receives the note, without the new columns', async () => {
...
describe('the sender reads their own notes back, with outcomes', () => {
  ...
  it('falls back to the base columns on a database without 0236', async () => {
...
describe('a steward’s "Fixed" carries what changed and when', () => {
  ...
  it('PROVEN TO CATCH: on a database without 0236 the status still lands', async () => {
