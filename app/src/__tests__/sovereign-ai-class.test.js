...
describe('curriculum shape', () => {
  it('has the full 16-week module set (week 16: trust the counsel you can actually trust, captured 2026-08-28)', () => {
    expect(SOVEREIGN_AI_MODULES).toHaveLength(16);
    expect(SOVEREIGN_AI_META.weeks).toBe(16);
