...
describe('curriculum shape', () => {
  it('has the full 12-week module set (week 12: the engineering disaster, captured 2026-08-25)', () => {
    expect(SOVEREIGN_AI_MODULES).toHaveLength(12);
    expect(SOVEREIGN_AI_META.weeks).toBe(12);
