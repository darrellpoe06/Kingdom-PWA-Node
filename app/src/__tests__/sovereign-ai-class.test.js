...
describe('curriculum shape', () => {
  it('has the full 17-week module set (week 17: the judge and the just weight, captured 2026-09-14)', () => {
    expect(SOVEREIGN_AI_MODULES).toHaveLength(17);
    expect(SOVEREIGN_AI_META.weeks).toBe(17);
