...
// =============================================================================
// L188 — The Acceptable Year and the Whole Counsel
// =============================================================================
//
...
const ID = 'll188-the-acceptable-year-and-the-whole-counsel';
...
describe('the lesson exists and is wired', () => {
  it('is the 188th Living Lesson and sits after L187', () => {
    expect(L, 'L188 is not in the series').toBeTruthy();
    ...
    expect(LIVING_LESSONS_MODULES[here - 1].id).toMatch(/^ll187-/);
  });
