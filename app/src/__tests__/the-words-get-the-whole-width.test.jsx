...
describe('a lesson card s prose is never squeezed into a column by its Share control', () => {
  ...
  it('each of the six prose sections puts Share on its own line beneath the words', () => {
    const s = learn();
    ...
    // six since DR-0601 added the worked case (an actual claim with the data)
    // — caught by this gate on CI (run 35949389412) when the block shipped
    ...
    expect(s).toMatch(/flex justify-end mt-1">\{sec\('Work the case'/);
  });
