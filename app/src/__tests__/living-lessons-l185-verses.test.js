...
// =============================================================================
// L185 — Glory to Glory: One Letter Holds Both Sides
// =============================================================================
...
const ID = 'll185-glory-to-glory-one-letter-holds-both-sides';
...
describe('the lesson exists and is wired', () => {
  it('is the newest Living Lesson and the count stays honest', () => {
    ...
    expect(LIVING_LESSONS_MODULES[here - 1].id).toMatch(/^ll184-/);
  });
