// =============================================================================
// L116 — "Know your own post": her provision, her guard, and the beam in the
...
// worthless.
//
// NUMBERING: this is L116, not L115. L115 is deliberately reserved for PR #1428
...
// KJV by a single character. Authoring L116 produced ZERO in-quote alterations
...
const ID = 'll116-know-your-own-post-her-provision-her-guard-and-the-beam-in-the-pointing-eye';
...
describe('L116 exists in the catalog with its full shape', () => {
  ...
  it('is registered in the live series and the painted lesson count is the real one', () => {
    ...
    expect(m, 'L116 must be in LIVING_LESSONS_MODULES').toBeTruthy();
  ...
  it('does not collide with L114, and leaves L115 free for the concurrent lesson', () => {
    ...
    expect(ids.filter((i) => i.startsWith('ll116-')).length, 'exactly one L116').toBe(1);
