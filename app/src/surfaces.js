...
export const SURFACES = [
  ...
  { id: 'ari',              label: 'Talk to Ari',   nav: 'church', view: 'church', sub: 'ari',        gate: 'isChurchStaff', load: () => import('./components/AriInbox.jsx') },
...
export const AriInbox         = surfaceById['ari'].component;
