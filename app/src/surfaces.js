...
export const SURFACES = [
  ...
  { id: 'giving',           label: 'Record Giving', nav: 'church', view: 'church', sub: 'giving',     gate: 'isChurchStaff', load: () => import('./components/RecordGiving.jsx') },
...
export const RecordGiving     = surfaceById['giving'].component;
