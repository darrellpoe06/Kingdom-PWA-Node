...
export const SURFACES = [
  ...
  { id: 'rap-study',        label: 'Bible Study',   nav: 'church', view: 'church', sub: 'rap-study',  load: () => import('./components/RapStudy.jsx') },
...
export const RapStudy         = surfaceById['rap-study'].component;
