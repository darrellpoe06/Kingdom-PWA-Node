...
export const SURFACES = [
  ...
  { id: 'kitchen',      label: 'Kitchen',          nav: 'top', view: 'kitchen',      sub: null,          gate: 'family/governor',                            load: () => import('./components/KitchenInventory.jsx') },
...
export const KitchenInventory = surfaceById['kitchen'].component;
