-- =============================================================================
-- 0059 — project board tasks: the Monday.com-style working board items
-- =============================================================================
-- (Numbered 0059: 0058 is already claimed on main by 0058-video-transcripts.sql,
-- so board_tasks takes the next free number — claim-your-number per
-- HYBRID-MODULAR-IMPLEMENTATION-PLAN Stage 4.)
