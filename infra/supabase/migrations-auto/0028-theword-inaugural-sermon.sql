-- =============================================================================
-- 0027 — The Word — Migdal: inaugural archived sermon (Darrell 2026-06-16)
-- =============================================================================
...
-- video_id) so the lane never duplicates it. Runs after 0011 (table) + 0012
-- (instance) + 0013 (backfill).
--
