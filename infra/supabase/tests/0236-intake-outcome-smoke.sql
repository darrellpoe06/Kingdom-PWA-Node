-- =============================================================================
-- 0236 INTAKE OUTCOME SMOKE — the outcome and the fix queue (DR-0625)
-- =============================================================================
-- Run as postgres AFTER applying 0236, in a transaction that ROLLS BACK.
-- PROVES:
...
INSERT INTO instances (id, slug, display_name, instance_type) VALUES
  (:'instF', 'fam-0236', 'Intake smoke family', 'family'),
  (:'instG', 'fam2-0236','Intake smoke other',  'family');
