#!/usr/bin/env node
// =============================================================================
// append-pride-verses — add the "Pride & the Increase" cards' verses to
...
//
// Run:  node scripts/append-pride-verses.mjs
...
const REFS = [
  // Pride goes before the fall / Nebuchadnezzar abased
  'Proverbs 16:18', 'Daniel 4:37',
  // The increase is the Lord's / except the Lord build the house
...
function main() {
  ...
  if (added === 0) {
    console.log('append-pride-verses: OK — all references already present (no-op).');
    return;
  }
  ...
  console.log(`append-pride-verses: OK — added ${added} verbatim KJV verses to lib/scripture-kjv.js`);
}
